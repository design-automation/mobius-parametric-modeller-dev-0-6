...
// Parameter: {"name":"road_art_w","value":22,"type":1,"min":"10","max":"30","step":"1"}
// Parameter: {"name":"road_sec_w","value":21,"type":1,"min":"10","max":"30","step":"1"}
// Parameter: {"name":"road_loc_w","value":18,"type":1,"min":"5","max":"30","step":"1"}
...
// Parameter: {"name":"part_og_d","value":37,"type":1,"min":"5","max":"50","step":"1"}
// Parameter: {"name":"part_og_w","value":25,"type":1,"min":"5","max":"50","step":"1"}
// Parameter: {"name":"plot_art_w","value":19,"type":1,"min":"5","max":"50","step":"1"}
// Parameter: {"name":"plot_sec_w","value":"10","type":1,"min":"5","max":"50","step":"3"}
// Parameter: {"name":"plot_loc_w","value":"10","type":1,"min":"5","max":"50","step":"3"}
...
// Parameter: {"name":"blk_loc_num_og_w","value":6,"type":1,"min":"0","max":"10","step":"1"}
// Parameter: {"name":"path_w","value":6,"type":1,"min":"3","max":"10","step":"1"}
// Parameter: {"name":"open_percent","value":4.5,"type":1,"min":"3","max":"10","step":"0.1"}
// Parameter: {"name":"amen_percent","value":7.4,"type":1,"min":"5","max":"15","step":"0.1"}


async function neighbourhood(__modules__, road_art_w, road_sec_w, road_loc_w, part_art_d, part_sec_d, part_loc_d, part_og_d, part_og_w, plot_art_w, plot_sec_w, plot_loc_w, blk_art_num_og_d, blk_art_num_og_w, blk_sec_num_og_d, blk_sec_num_og_w, blk_loc_num_og_d, blk_loc_num_og_w, path_w, open_percent, amen_percent) {
...
async function exec_neighbourhood_node_vns93romfj_cleanPgonEdge_(__params__, pgon_) {
...
async function exec_neighbourhood_node_vns93romfj_cleanPgonAng_(__params__, pgon_) {

let del_posis_ = [];

for (let  vert_ of __modules__.query.Get(__params__.model, '_v', pgon_)){

let dot_ = await exec_neighbourhood_node_vns93romfj_angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_vns93romfj_angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_vns93romfj(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);

let landowners_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "site");

__modules__.modify.Delete( __params__.model, __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '!=', "site"), 'delete_selected' );

let site_combined_ = __modules__.poly2d.Union( __params__.model, landowners_ );

for (let  site_ of site_combined_){

await exec_neighbourhood_node_vns93romfj_cleanPgonEdge_(__params__, site_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_vns93romfj_cleanPgonAng_(__params__, site_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_pjizno9ndm8(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let road_sec_exist_ = __modules__.query.Filter(__params__.model, road_sec_, ['osm_id', null], '!=', "new");

let road_sec_new_ = __modules__.query.Filter(__params__.model, road_sec_, ['osm_id', null], '==', "new");
...
road_sec_exist_ = __modules__.poly2d.OffsetMitre( __params__.model, road_sec_exist_, road_sec_w_ / 2, 20, 'square_end' );

road_sec_new_ = __modules__.poly2d.OffsetMitre( __params__.model, road_sec_new_, road_sec_w_ / 2, 20, 'square_end' );

let road_area_art_ = __modules__.poly2d.Boolean( __params__.model, road_art_, sites_, 'intersect' );

let sites2_ = __modules__.poly2d.Boolean( __params__.model, sites_, road_art_, 'difference' );

let road_area_sec_exist_ = __modules__.poly2d.Boolean( __params__.model, road_sec_exist_, sites2_, 'intersect' );

let road_area_sec_new_ = __modules__.poly2d.Boolean( __params__.model, road_sec_new_, sites2_, 'intersect' );

__modules__.modify.Delete( __params__.model, [road_area_art_, road_area_sec_exist_, road_area_sec_new_], 'keep_selected' );

let area_art_ = __modules__.calc.Area( __params__.model, road_area_art_ );

let area_sec_ = __modules__.calc.Area( __params__.model, listFlat([road_area_sec_exist_, road_area_sec_new_]) );

__modules__.attrib.Set(__params__.model, null, 'road_area_art',  sum(area_art_) );

__modules__.attrib.Set(__params__.model, null, 'road_area_sec',  sum(area_sec_) );
__modules__._model.__postprocess__( __params__.model);
break; }
return __params__.model;
}
...
async function exec_neighbourhood_node_hm6u1njdu3f(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_knp6k1v58dq(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_elz3xtiqwf8_bounce_(__params__, pgons_, bounce_) {
...
async function exec_neighbourhood_node_elz3xtiqwf8_cleanPgonEdge_(__params__, pgon_) {
...
async function exec_neighbourhood_node_elz3xtiqwf8_cleanPgonAng_(__params__, pgon_) {

let del_posis_ = [];

for (let  vert_ of __modules__.query.Get(__params__.model, '_v', pgon_)){

let dot_ = await exec_neighbourhood_node_elz3xtiqwf8_angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_elz3xtiqwf8_angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_elz3xtiqwf8(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);

let big_site_ = __modules__.query.Get(__params__.model, 'pg', null);
...
let site_pline_ = __modules__.make.Polyline( __params__.model, big_site_, 'close' );
...
await exec_neighbourhood_node_elz3xtiqwf8_cleanPgonEdge_(__params__, site_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_elz3xtiqwf8_cleanPgonAng_(__params__, site_);
if (__params__.terminated) { return __params__.model;}
}
...
for (let  i_ of range(len(divided_sites_))){

let area_ = __modules__.calc.Area( __params__.model, divided_sites_[pythonList(i_, divided_sites_.length)] );

let cen_ = __modules__.calc.Centroid( __params__.model, divided_sites_[pythonList(i_, divided_sites_.length)], 'center_of_mass' );
...
__modules__.attrib.Set( __params__.model, divided_sites_[pythonList(i_, divided_sites_.length)], "name", site_name_, 'one_value' );
...
async function exec_neighbourhood_node_4gdnewpxwwu(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_2c4juo1tti6(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_w96d0ucdegl_getPlines_(__params__, pgon_, road_type_) {
...
async function exec_neighbourhood_node_w96d0ucdegl(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let pline_ = await exec_neighbourhood_node_w96d0ucdegl_getPlines_(__params__, site_, "road_art");
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, pline_, 'type',  "road_art" );

pline_ = await exec_neighbourhood_node_w96d0ucdegl_getPlines_(__params__, site_, "road_sec");
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, pline_, 'type',  "road_sec" );

pline_ = await exec_neighbourhood_node_w96d0ucdegl_getPlines_(__params__, site_, "road_ter");
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, pline_, 'type',  "road_ter" );

pline_ = await exec_neighbourhood_node_w96d0ucdegl_getPlines_(__params__, site_, "cold");
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_5p4odknefru(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let roads_loc_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '!=', "block");

let roads_loc_areas_ = __modules__.calc.Area( __params__.model, roads_loc_ );

__modules__.attrib.Set(__params__.model, null, 'road_area_loc',  sum(roads_loc_areas_) );
__modules__._model.__postprocess__( __params__.model);
break; }
return __params__.model;
}
...
async function exec_neighbourhood_node_eoe23c5qyyu_trimLocalRoad_(__params__, edge_, main_rays_, trim_end_) {
...
async function exec_neighbourhood_node_eoe23c5qyyu(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
await exec_neighbourhood_node_eoe23c5qyyu_trimLocalRoad_(__params__, __modules__.query.Get(__params__.model, '_e', verts_[pythonList(0, verts_.length)])[pythonList(0, __modules__.query.Get(__params__.model, '_e', verts_[pythonList(0, verts_.length)]).length)], main_rays_, false);
if (__params__.terminated) { return __params__.model;}
}
...
await exec_neighbourhood_node_eoe23c5qyyu_trimLocalRoad_(__params__, __modules__.query.Get(__params__.model, '_e', verts_[pythonList(-1, verts_.length)])[pythonList(0, __modules__.query.Get(__params__.model, '_e', verts_[pythonList(-1, verts_.length)]).length)], main_rays_, true);
if (__params__.terminated) { return __params__.model;}
}
}
...
async function exec_neighbourhood_node_1i0m7sn8thsi(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_6g0o7kaz6sc(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_hbqvmbucuob_getCentralBlock_(__params__, blocks_, site_cen_) {
...
async function exec_neighbourhood_node_hbqvmbucuob(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let cen_block_ = await exec_neighbourhood_node_hbqvmbucuob_getCentralBlock_(__params__, blocks_, site_cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_kw8bpjsjyf7_createExtendedRoads_(__params__, block_) {

let roads_art_ = await exec_neighbourhood_node_kw8bpjsjyf7__getPerimPlines_(__params__, block_, "road_art");
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_kw8bpjsjyf7__extendPline_(__params__, roads_art_, 100);
if (__params__.terminated) { return __params__.model;}

let roads_sec_ = await exec_neighbourhood_node_kw8bpjsjyf7__getPerimPlines_(__params__, block_, "road_sec");
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_kw8bpjsjyf7__extendPline_(__params__, roads_sec_, 100);
if (__params__.terminated) { return __params__.model;}

let roads_loc_ = await exec_neighbourhood_node_kw8bpjsjyf7__getPerimPlines_(__params__, block_, "road_loc");
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_kw8bpjsjyf7__extendPline_(__params__, roads_loc_, 100);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_kw8bpjsjyf7_createOffGridArea_(__params__, block_, roads_) {
...
off_grids_ = await exec_neighbourhood_node_kw8bpjsjyf7__cleanPgonsEdge_(__params__, off_grids_);
if (__params__.terminated) { return __params__.model;}

off_grids_ = await exec_neighbourhood_node_kw8bpjsjyf7__cleanPgonsAng_(__params__, off_grids_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_kw8bpjsjyf7_createBlockPartsFromOffGrid_(__params__, block_, off_grid_) {
...
let ang_ = await exec_neighbourhood_node_kw8bpjsjyf7__vertAng_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
let perim_posis_ = await exec_neighbourhood_node_kw8bpjsjyf7__getPosisBetweenEdges_(__params__, a_[pythonList(2, a_.length)][pythonList(1, a_[pythonList(2, a_.length)].length)], b_[pythonList(2, b_.length)][pythonList(0, b_[pythonList(2, b_.length)].length)], true);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_kw8bpjsjyf7__setAttribs_(__params__, block_, listFlat([corner_parts_, side_parts_]), off_grid_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_kw8bpjsjyf7__transferEdgeAttribsTouchingPart_(__params__, corner_parts_e_, side_parts_e_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_kw8bpjsjyf7__transferEdgeAttribsTouchingPart_(__params__, side_parts_e_, corner_parts_e_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_kw8bpjsjyf7__transferEdgeAttribsTouchingPart_(__params__, off_grid_e_, side_parts_e_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_kw8bpjsjyf7__transferEdgeAttribsTouchingPart_(__params__, side_parts_e_, off_grid_e_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_kw8bpjsjyf7__isectRays_(__params__, ray_, rays_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__cleanPgonsEdge_(__params__, pgons_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__cleanPgonsAng_(__params__, pgons_) {
...
let dot_ = await exec_neighbourhood_node_kw8bpjsjyf7__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_kw8bpjsjyf7__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__getPerimPlines_(__params__, site_, road_descr_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__setAttribs_(__params__, block_, parts_, off_grid_) {

for (let  part_ of parts_){

await exec_neighbourhood_node_kw8bpjsjyf7__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', block_), __modules__.query.Get(__params__.model, '_e', part_));
if (__params__.terminated) { return __params__.model;}

if (__modules__.attrib.Get(__params__.model, part_, 'type')== "side"){

await exec_neighbourhood_node_kw8bpjsjyf7__addAttribs_(__params__, part_, true);
if (__params__.terminated) { return __params__.model;}
}

else {

await exec_neighbourhood_node_kw8bpjsjyf7__addAttribs_(__params__, part_, false);
if (__params__.terminated) { return __params__.model;}
}
}
...
await exec_neighbourhood_node_kw8bpjsjyf7__addAttribs_(__params__, off_grid_, false);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_kw8bpjsjyf7__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__extendPline_(__params__, plines_, dist_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__addAttribs_(__params__, part_, is_side_part_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_kw8bpjsjyf7__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_kw8bpjsjyf7__transferEdgeAttribsTouchingPart_(__params__, from_edges_, to_edges_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7__getPosisBetweenEdges_(__params__, edge0_, edge1_, forwards_) {
...
async function exec_neighbourhood_node_kw8bpjsjyf7(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let roads_ = await exec_neighbourhood_node_kw8bpjsjyf7_createExtendedRoads_(__params__, block_);
if (__params__.terminated) { return __params__.model;}

let off_grid_ = await exec_neighbourhood_node_kw8bpjsjyf7_createOffGridArea_(__params__, block_, roads_);
if (__params__.terminated) { return __params__.model;}
...
let parts_ = await exec_neighbourhood_node_kw8bpjsjyf7_createBlockPartsFromOffGrid_(__params__, block_, off_grid_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5_createParts_(__params__, block_, depths_dict_) {

let plines_art_ = await exec_neighbourhood_node_fkmuzw4ixv5__getPerimPlines_(__params__, block_, "road_art");
if (__params__.terminated) { return __params__.model;}

let plines_sec_ = await exec_neighbourhood_node_fkmuzw4ixv5__getPerimPlines_(__params__, block_, "road_sec");
if (__params__.terminated) { return __params__.model;}
...
let result_ = await exec_neighbourhood_node_fkmuzw4ixv5__trimLoc_(__params__, block_, [art_bool1_, art_bool2_]);
if (__params__.terminated) { return __params__.model;}
...
let result_ = await exec_neighbourhood_node_fkmuzw4ixv5__trimLoc_(__params__, block_, [sec_bool1_, sec_bool2_]);
if (__params__.terminated) { return __params__.model;}
...
let result_ = await exec_neighbourhood_node_fkmuzw4ixv5__trimLoc_(__params__, block_, [art_corners_, other_corners_, art_bool1_trim_, art_bool2_trim_]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5_transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_fkmuzw4ixv5__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5_addTypeAttribsCrvRoads_(__params__, part_) {

let part_edges_ = __modules__.query.Get(__params__.model, '_e', part_);

let road_types_ = [];

let art_ = await exec_neighbourhood_node_fkmuzw4ixv5__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_art");
if (__params__.terminated) { return __params__.model;}

let sec_ = await exec_neighbourhood_node_fkmuzw4ixv5__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_sec");
if (__params__.terminated) { return __params__.model;}

let loc_ = await exec_neighbourhood_node_fkmuzw4ixv5__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_loc");
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5_transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_fkmuzw4ixv5_copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_fkmuzw4ixv5__getCrvRoadEdgeTypes_(__params__, part_edges_, road_descr_) {
...
let ang_ = await exec_neighbourhood_node_fkmuzw4ixv5__vertAng_(__params__, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)])[pythonList(0, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)]).length)]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_fkmuzw4ixv5__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_fkmuzw4ixv5__trimLoc_(__params__, block_, parts_) {

let plines_loc_ = await exec_neighbourhood_node_fkmuzw4ixv5__getPerpLocPlines_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5__getPerimPlines_(__params__, block_, road_descr_) {
...
await exec_neighbourhood_node_fkmuzw4ixv5__extendPline_(__params__, site_plines_, 100);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5__getPerpLocPlines_(__params__, block_) {
...
await exec_neighbourhood_node_fkmuzw4ixv5__extendPline_(__params__, plines_, 100);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fkmuzw4ixv5__extendPline_(__params__, plines_, dist_) {
...
async function exec_neighbourhood_node_fkmuzw4ixv5(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let parts_ = await exec_neighbourhood_node_fkmuzw4ixv5_createParts_(__params__, block_, depths_dict_);
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, parts_, 'class',  "part" );

await exec_neighbourhood_node_fkmuzw4ixv5_copyAttribs_(__params__, block_, parts_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_fkmuzw4ixv5_transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', block_), __modules__.query.Get(__params__.model, '_e', parts_));
if (__params__.terminated) { return __params__.model;}

for (let  part_ of parts_){

await exec_neighbourhood_node_fkmuzw4ixv5_addTypeAttribsCrvRoads_(__params__, part_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_fkmuzw4ixv5_transferEdgeAttribsBtwTouchingParts_(__params__, parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_o3rnayqjeg_createParts_(__params__, block_, depths_dict_) {

let quad_ = await exec_neighbourhood_node_o3rnayqjeg__convertToQuad_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_o3rnayqjeg__transferEdgeAttribs_(__params__, blk_edges_, quad_edges_, false);
if (__params__.terminated) { return __params__.model;}
...
parts_ = await exec_neighbourhood_node_o3rnayqjeg_creat4Parts_(__params__, blk_edges_, quad_edges_, rays_, [a_, b_, c_, d_], xyz_cen_);
if (__params__.terminated) { return __params__.model;}
...
parts_ = await exec_neighbourhood_node_o3rnayqjeg_creat5Parts_(__params__, blk_edges_, quad_edges_, rays_, [a_, b_, c_, d_], [xyz_a_, xyz_c_], lengths_[pythonList(a_, lengths_.length)] < lengths_[pythonList(c_, lengths_.length)]);
if (__params__.terminated) { return __params__.model;}
...
parts_ = await exec_neighbourhood_node_o3rnayqjeg_creat6Parts_(__params__, blk_edges_, quad_edges_, rays_, [a_, b_, c_, d_], [xyz_a_, xyz_c_]);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_o3rnayqjeg__transferEdgeAttribs_(__params__, blk_edges_, __modules__.query.Get(__params__.model, '_e', part_), true);
if (__params__.terminated) { return __params__.model;}
}

await exec_neighbourhood_node_o3rnayqjeg__copyAttribs_(__params__, block_, parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_o3rnayqjeg_creat4Parts_(__params__, blk_edges_, quad_edges_, rays_, abcd_, xyz_cen_) {
...
async function exec_neighbourhood_node_o3rnayqjeg_creat5Parts_(__params__, blk_edges_, quad_edges_, rays_, abcd_, xyzs_, a_is_short_) {
...
async function exec_neighbourhood_node_o3rnayqjeg_creat6Parts_(__params__, blk_edges_, quad_edges_, rays_, abcd_, xyzs_) {
...
async function exec_neighbourhood_node_o3rnayqjeg_addTypeAttribsCrvRoads_(__params__, parts_) {
...
let art_ = await exec_neighbourhood_node_o3rnayqjeg__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_art");
if (__params__.terminated) { return __params__.model;}

let sec_ = await exec_neighbourhood_node_o3rnayqjeg__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_sec");
if (__params__.terminated) { return __params__.model;}

let loc_ = await exec_neighbourhood_node_o3rnayqjeg__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_loc");
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_o3rnayqjeg_transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
let from_edge_ = await exec_neighbourhood_node_o3rnayqjeg__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_o3rnayqjeg__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_o3rnayqjeg__getCrvRoadEdgeTypes_(__params__, part_edges_, road_descr_) {
...
let ang_ = await exec_neighbourhood_node_o3rnayqjeg__vertAng_(__params__, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)])[pythonList(0, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)]).length)]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_o3rnayqjeg__convertToQuad_(__params__, pgon_) {
...
let dot_ = await exec_neighbourhood_node_o3rnayqjeg__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_o3rnayqjeg__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_o3rnayqjeg__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_o3rnayqjeg__transferEdgeAttribs_(__params__, from_edges_, to_edges_, must_touch_) {
...
from_edge_ = await exec_neighbourhood_node_o3rnayqjeg__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
}

else {

from_edge_ = await exec_neighbourhood_node_o3rnayqjeg__closestEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_o3rnayqjeg__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_o3rnayqjeg__closestEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_o3rnayqjeg__projectOntoEdge_(__params__, xyz_, edges_) {
...
async function exec_neighbourhood_node_o3rnayqjeg(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let parts_ = await exec_neighbourhood_node_o3rnayqjeg_createParts_(__params__, block_, depths_dict_);
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, parts_, 'class',  "part" );

await exec_neighbourhood_node_o3rnayqjeg_addTypeAttribsCrvRoads_(__params__, parts_);
if (__params__.terminated) { return __params__.model;}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_gdxt2hr7i5k_subdivOfGrid_(__params__, off_grid_) {
...
let quad_tri_ = await exec_neighbourhood_node_gdxt2hr7i5k__convertOffGridToQuadTri_(__params__, off_grid_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_gdxt2hr7i5k__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', off_grid_), __modules__.query.Get(__params__.model, '_e', tri_));
if (__params__.terminated) { return __params__.model;}
...
let posis_ = await exec_neighbourhood_node_gdxt2hr7i5k__createClusterPosis_(__params__, quad_tri_[pythonList(0, quad_tri_.length)], swap_orientation_);
if (__params__.terminated) { return __params__.model;}

let parts_ = await exec_neighbourhood_node_gdxt2hr7i5k__createClusterParts_(__params__, off_grid_, off_grid_parts_, posis_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_gdxt2hr7i5k__transferEdgeAttribsBtwTouchingParts_(__params__, parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_gdxt2hr7i5k__convertOffGridToQuadTri_(__params__, off_grid_) {
...
let dot_ = await exec_neighbourhood_node_gdxt2hr7i5k__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_gdxt2hr7i5k__transferEdgeAttribsClosest_(__params__, off_grid_edges_, __modules__.query.Get(__params__.model, '_e', pgon2_));
if (__params__.terminated) { return __params__.model;}
...
chopped_ = await exec_neighbourhood_node_gdxt2hr7i5k_makeChopped_(__params__, new_xyz_, __modules__.attrib.Get(__params__.model,  __modules__.query.Get(__params__.model, 'ps', edges_[pythonList(0, edges_.length)])[pythonList(0, __modules__.query.Get(__params__.model, 'ps', edges_[pythonList(0, edges_.length)]).length)], 'xyz'));
if (__params__.terminated) { return __params__.model;}
}
...
chopped_ = await exec_neighbourhood_node_gdxt2hr7i5k_makeChopped_(__params__, __modules__.attrib.Get(__params__.model,  __modules__.query.Get(__params__.model, 'ps', edges_[pythonList(1, edges_.length)])[pythonList(1, __modules__.query.Get(__params__.model, 'ps', edges_[pythonList(1, edges_.length)]).length)], 'xyz'), new_xyz_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_gdxt2hr7i5k_makeChopped_(__params__, xyz0_, xyz1_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__convertPartToQuad_(__params__, part_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__createClusterPosis_(__params__, quad_, swap_orientation_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__createClusterParts_(__params__, off_grid_, off_grid_ex_, posis_) {
...
await exec_neighbourhood_node_gdxt2hr7i5k__transferEdgeAttribsTouching_(__params__, off_grid_e_, __modules__.query.Get(__params__.model, '_e', part2_));
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_gdxt2hr7i5k__trimTri_(__params__, off_grid_, tri_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__closestEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_gdxt2hr7i5k__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_gdxt2hr7i5k__transferEdgeAttribsClosest_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_gdxt2hr7i5k__closestEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_gdxt2hr7i5k__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k_isect_(__params__, ray_, rays_) {
...
async function exec_neighbourhood_node_gdxt2hr7i5k(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let parts_ = await exec_neighbourhood_node_gdxt2hr7i5k_subdivOfGrid_(__params__, off_grid_);
if (__params__.terminated) { return __params__.model;}

let num_parts_ = len( __modules__.query.Filter(__params__.model, parts_, ['type', null], '==', "off_grid0"));

cluster_num_[pythonList(block_type_, cluster_num_.length)] = cluster_num_[pythonList(block_type_, cluster_num_.length)] + num_parts_;
}

__modules__.attrib.Set(__params__.model, null, 'og_clus0_on_art_num',  cluster_num_['art'] );

__modules__.attrib.Set(__params__.model, null, 'og_clus0_on_sec_num',  cluster_num_['sec'] );

__modules__.attrib.Set(__params__.model, null, 'og_clus0_on_loc_num',  cluster_num_['loc'] );
__modules__._model.__postprocess__( __params__.model);
break; }
return __params__.model;
}
...
async function exec_neighbourhood_node_mx5n1w8ixqf_processBlock_(__params__, block_) {

await exec_neighbourhood_node_mx5n1w8ixqf__cleanPgonEdge_(__params__, block_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_mx5n1w8ixqf__cleanPgonAng_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
}


async function exec_neighbourhood_node_mx5n1w8ixqf__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_mx5n1w8ixqf__cleanPgons_(__params__, pgons_) {

for (let  pgon_ of pgons_){

await exec_neighbourhood_node_mx5n1w8ixqf__cleanPgonEdge_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_mx5n1w8ixqf__cleanPgonAng_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_mx5n1w8ixqf__cleanPgonEdge_(__params__, pgon_) {
...
async function exec_neighbourhood_node_mx5n1w8ixqf__cleanPgonAng_(__params__, pgon_) {

let del_posis_ = [];

for (let  vert_ of __modules__.query.Get(__params__.model, '_v', pgon_)){

let dot_ = await exec_neighbourhood_node_mx5n1w8ixqf__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_mx5n1w8ixqf(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
await exec_neighbourhood_node_mx5n1w8ixqf_processBlock_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_fq5z4j8z3n_subdivBlock_(__params__, block_) {
...
let result_ = await exec_neighbourhood_node_fq5z4j8z3n__getEdgesOnRoads_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
let ang0_ = await exec_neighbourhood_node_fq5z4j8z3n__vertAng_(__params__, verts_[pythonList(0, verts_.length)]);
if (__params__.terminated) { return __params__.model;}

let ang1_ = await exec_neighbourhood_node_fq5z4j8z3n__vertAng_(__params__, verts_[pythonList(1, verts_.length)]);
if (__params__.terminated) { return __params__.model;}
...
let edge_a_ = await exec_neighbourhood_node_fq5z4j8z3n__getLongestEdge_(__params__, edges_to_cut_);
if (__params__.terminated) { return __params__.model;}
...
let isect_ = await exec_neighbourhood_node_fq5z4j8z3n__isect_(__params__, ray_, other_edges_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
let subdiv_ = await exec_neighbourhood_node_fq5z4j8z3n__makeSubdivs_(__params__, block_posis_, null, cut_, null, posis_);
if (__params__.terminated) { return __params__.model;}
...
subdiv_ = await exec_neighbourhood_node_fq5z4j8z3n__makeSubdivs_(__params__, block_posis_, cut_, null, posis_, null);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_fq5z4j8z3n__transferEdgeAttribs_(__params__, block_edges_, __modules__.query.Get(__params__.model, '_e', subdivs_));
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_fq5z4j8z3n__transferEdgeAttribsBtwTouchingParts_(__params__, subdivs_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_fq5z4j8z3n__copyAttribs_(__params__, block_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fq5z4j8z3n__getLongestEdge_(__params__, edges_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n__transferEdgeAttribs_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_fq5z4j8z3n__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fq5z4j8z3n__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n__getEdgesOnRoads_(__params__, block_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n__isect_(__params__, ray_, edges_, subdivs_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n__makeSubdivs_(__params__, block_posis_, cut0_, cut1_, posis0_, posis1_) {
...
let posis_list_ = await exec_neighbourhood_node_fq5z4j8z3n__getPosisFromRing_(__params__, block_posis_, [cut1_[pythonList(1, cut1_.length)], cut1_[pythonList(0, cut1_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_fq5z4j8z3n__getPosisFromRing_(__params__, block_posis_, [cut0_[pythonList(0, cut0_.length)], cut0_[pythonList(1, cut0_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_fq5z4j8z3n__getPosisFromRing_(__params__, block_posis_, [cut1_[pythonList(1, cut1_.length)], cut0_[pythonList(1, cut0_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
posis_list_ = await exec_neighbourhood_node_fq5z4j8z3n__getPosisFromRing_(__params__, block_posis_, [cut0_[pythonList(0, cut0_.length)], cut1_[pythonList(0, cut1_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fq5z4j8z3n__getPosisFromRing_(__params__, posis_, idxs_) {
...
async function exec_neighbourhood_node_fq5z4j8z3n(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let subdivs_ = await exec_neighbourhood_node_fq5z4j8z3n_subdivBlock_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_0ib4xajdpzy_subdivBlock_(__params__, block_) {
...
let result_ = await exec_neighbourhood_node_0ib4xajdpzy__getEdgesOnRoads_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
let ang_ = await exec_neighbourhood_node_0ib4xajdpzy__vertAng_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
isect_a_ = await exec_neighbourhood_node_0ib4xajdpzy__isect_(__params__, ray_a_, other_edges_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
isect_b_ = await exec_neighbourhood_node_0ib4xajdpzy__isect_(__params__, ray_b_, other_edges_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
let subdiv_ = await exec_neighbourhood_node_0ib4xajdpzy__makeSubdivs2_(__params__, block_posis_, cut0_, cut1_, posis0_, posis1_);
if (__params__.terminated) { return __params__.model;}
...
subdiv_ = await exec_neighbourhood_node_0ib4xajdpzy__makeSubdivs2_(__params__, block_posis_, cut0_, cut1_, posis0_, posis1_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_0ib4xajdpzy__transferEdgeAttribs_(__params__, block_edges_, __modules__.query.Get(__params__.model, '_e', subdivs_));
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_0ib4xajdpzy__transferEdgeAttribsBtwTouchingParts_(__params__, subdivs_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_0ib4xajdpzy__copyAttribs_(__params__, block_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_0ib4xajdpzy__transferEdgeAttribs_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_0ib4xajdpzy__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_0ib4xajdpzy__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_0ib4xajdpzy__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_0ib4xajdpzy__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_0ib4xajdpzy__getEdgesOnRoads_(__params__, block_) {
...
async function exec_neighbourhood_node_0ib4xajdpzy__isect_(__params__, ray_, edges_, subdivs_) {
...
async function exec_neighbourhood_node_0ib4xajdpzy__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_0ib4xajdpzy__makeSubdivs2_(__params__, block_posis_, cut0_, cut1_, posis0_, posis1_) {
...
let posis_list_ = await exec_neighbourhood_node_0ib4xajdpzy__getPosisFromRing_(__params__, block_posis_, [cut1_[pythonList(1, cut1_.length)], cut1_[pythonList(0, cut1_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_0ib4xajdpzy__getPosisFromRing_(__params__, block_posis_, [cut0_[pythonList(0, cut0_.length)], cut0_[pythonList(1, cut0_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_0ib4xajdpzy__getPosisFromRing_(__params__, block_posis_, [cut1_[pythonList(1, cut1_.length)], cut0_[pythonList(1, cut0_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
posis_list_ = await exec_neighbourhood_node_0ib4xajdpzy__getPosisFromRing_(__params__, block_posis_, [cut0_[pythonList(0, cut0_.length)], cut1_[pythonList(0, cut1_.length)]]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_0ib4xajdpzy__getPosisFromRing_(__params__, posis_, idxs_) {
...
async function exec_neighbourhood_node_0ib4xajdpzy(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let subdivs_ = await exec_neighbourhood_node_0ib4xajdpzy_subdivBlock_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_8f0wt4mmgwj(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_m0ivs8ifyp_processBlock_(__params__, block_) {

let roads_art_ = await exec_neighbourhood_node_m0ivs8ifyp__getSitePlines_(__params__, block_, "road_art");
if (__params__.terminated) { return __params__.model;}

let roads_sec_ = await exec_neighbourhood_node_m0ivs8ifyp__getSitePlines_(__params__, block_, "road_sec");
if (__params__.terminated) { return __params__.model;}

let roads_loc_ = await exec_neighbourhood_node_m0ivs8ifyp__getSitePlines_(__params__, block_, "road_loc");
if (__params__.terminated) { return __params__.model;}

let parts_ = await exec_neighbourhood_node_m0ivs8ifyp__createOnGridStrips_(__params__, block_, roads_art_, roads_sec_, roads_loc_);
if (__params__.terminated) { return __params__.model;}

parts_ = await exec_neighbourhood_node_m0ivs8ifyp__cleanPgons_(__params__, parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_m0ivs8ifyp__createOnGridStrips_(__params__, block_, roads_art_, roads_sec_, roads_loc_) {
...
await exec_neighbourhood_node_m0ivs8ifyp__transferEdgeAttribsBtwTouchingParts_(__params__, new_parts_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_m0ivs8ifyp__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', block_), __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, '_e', new_parts_), ['road', null], '==', null));
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_m0ivs8ifyp__copyAttribs_(__params__, block_, new_parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_m0ivs8ifyp__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_m0ivs8ifyp__cleanPgons_(__params__, pgons_) {

for (let  pgon_ of pgons_){

await exec_neighbourhood_node_m0ivs8ifyp__cleanPgonEdge_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_m0ivs8ifyp__cleanPgonAng_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_m0ivs8ifyp__cleanPgonEdge_(__params__, pgon_) {
...
async function exec_neighbourhood_node_m0ivs8ifyp__cleanPgonAng_(__params__, pgon_) {

let del_posis_ = [];

for (let  vert_ of __modules__.query.Get(__params__.model, '_v', pgon_)){

let dot_ = await exec_neighbourhood_node_m0ivs8ifyp__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_m0ivs8ifyp__getSitePlines_(__params__, site_, road_descr_) {
...
async function exec_neighbourhood_node_m0ivs8ifyp__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_m0ivs8ifyp__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_m0ivs8ifyp__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_m0ivs8ifyp__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_m0ivs8ifyp__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_m0ivs8ifyp(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let result_ = await exec_neighbourhood_node_m0ivs8ifyp_processBlock_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_3kazw9j16ty_subdivParts_(__params__, part_) {
...
let ang_ = await exec_neighbourhood_node_3kazw9j16ty__vertAng_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
let corner_ = await exec_neighbourhood_node_3kazw9j16ty__makeConvexCorner_(__params__, vert_, part_depth_);
if (__params__.terminated) { return __params__.model;}
...
strips_ = await exec_neighbourhood_node_3kazw9j16ty__fixPinchedPgons_(__params__, strips_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_3kazw9j16ty__attribs_(__params__, part_, corners_trim_, strips_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_3kazw9j16ty__attribs_(__params__, part_, corners_, strips_) {

let part_edges_ = __modules__.query.Get(__params__.model, '_e', part_);

let part_type_ = __modules__.attrib.Get(__params__.model, part_, 'type');

await exec_neighbourhood_node_3kazw9j16ty__transferEdgeAttribsTouching_(__params__, part_edges_, __modules__.query.Get(__params__.model, '_e', corners_));
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, corners_, 'type',  part_type_ + '_' + part_type_ );

await exec_neighbourhood_node_3kazw9j16ty__transferEdgeAttribsTouching_(__params__, part_edges_, __modules__.query.Get(__params__.model, '_e', strips_));
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_3kazw9j16ty__copyAttribs_(__params__, part_, all_parts_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_3kazw9j16ty__transferEdgeAttribsBtwTouchingParts_(__params__, all_parts_);
if (__params__.terminated) { return __params__.model;}
}


async function exec_neighbourhood_node_3kazw9j16ty__makeConvexCorner_(__params__, vert_, part_depth_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__makeConcaveCorner_(__params__, vert_, part_depth_, plot_width_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__makeZigZagCorner_(__params__, edge_, part_depth_, plot_width_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__fixPinchedPgons_(__params__, pgons_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_3kazw9j16ty__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_3kazw9j16ty__transferEdgeAttribsTouchingPart_(__params__, from_edges_, to_edges_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_3kazw9j16ty__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_3kazw9j16ty(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let subdivs_ = await exec_neighbourhood_node_3kazw9j16ty_subdivParts_(__params__, part_);
if (__params__.terminated) { return __params__.model;}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_a30k6jwp7xi_subdivBlock_(__params__, block_) {
...
printFunc(__params__.console,'warm_edges', warm_edges_);

let road_edges_ = await exec_neighbourhood_node_a30k6jwp7xi__getEdgesOnParts_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
let ang_ = await exec_neighbourhood_node_a30k6jwp7xi__vertAng_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
let isect_a_ = await exec_neighbourhood_node_a30k6jwp7xi__isect_(__params__, ray_a_, cold_edges_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
let isect_b_ = await exec_neighbourhood_node_a30k6jwp7xi__isect_(__params__, ray_b_, cold_edges_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
let isect_perp_ = await exec_neighbourhood_node_a30k6jwp7xi__isect_(__params__, ray_perp_, cold_edges_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
let subdiv_ = await exec_neighbourhood_node_a30k6jwp7xi__makeSubdivs_(__params__, block_posis_, cut0_, cut1_, posi0_, posi1_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_a30k6jwp7xi__transferEdgeAttribs_(__params__, block_edges_, __modules__.query.Get(__params__.model, '_e', subdivs_));
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_a30k6jwp7xi__transferEdgeAttribsBtwTouchingParts_(__params__, subdivs_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_a30k6jwp7xi__copyAttribs_(__params__, block_, subdivs_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_a30k6jwp7xi__transferEdgeAttribs_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_a30k6jwp7xi__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_a30k6jwp7xi__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_a30k6jwp7xi__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_a30k6jwp7xi__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_a30k6jwp7xi__getEdgesOnParts_(__params__, block_) {
...
async function exec_neighbourhood_node_a30k6jwp7xi__isect_(__params__, ray_, edges_, subdivs_) {
...
async function exec_neighbourhood_node_a30k6jwp7xi__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_a30k6jwp7xi__makeSubdivs_(__params__, block_posis_, cut0_, cut1_, posi0_, posi1_) {
...
let posis_list_ = await exec_neighbourhood_node_a30k6jwp7xi__getPosisFromRing_(__params__, block_posis_, [cut1_[pythonList(1, cut1_.length)] + 1, cut1_[pythonList(0, cut1_.length)] + 1]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_a30k6jwp7xi__getPosisFromRing_(__params__, block_posis_, [cut0_[pythonList(0, cut0_.length)], cut0_[pythonList(1, cut0_.length)] + 1]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_a30k6jwp7xi__getPosisFromRing_(__params__, block_posis_, [cut1_[pythonList(1, cut1_.length)] + 1, cut0_[pythonList(1, cut0_.length)] + 1]);
if (__params__.terminated) { return __params__.model;}
...
posis_list_ = await exec_neighbourhood_node_a30k6jwp7xi__getPosisFromRing_(__params__, block_posis_, [cut0_[pythonList(0, cut0_.length)], cut1_[pythonList(0, cut1_.length)] + 1]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_a30k6jwp7xi__getPosisFromRing_(__params__, posis_, idxs_) {
...
async function exec_neighbourhood_node_a30k6jwp7xi(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let subdivs_ = await exec_neighbourhood_node_a30k6jwp7xi_subdivBlock_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_n6sk1b2l88a_getFrontEdges_(__params__, cluster_) {

let pline_ = await exec_neighbourhood_node_n6sk1b2l88a__getPerimPlines_(__params__, cluster_, "loc");
if (__params__.terminated) { return __params__.model;}

if (len(pline_) == 0){

pline_ = await exec_neighbourhood_node_n6sk1b2l88a__getPerimPlines_(__params__, cluster_, "sec");
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_n6sk1b2l88a_trimClusterDepth_(__params__, cluster_, front_edges_) {
...
await exec_neighbourhood_node_n6sk1b2l88a__copyAttribs_(__params__, cluster_, new_clusters_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_n6sk1b2l88a__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', cluster_), __modules__.query.Get(__params__.model, '_e', new_clusters_));
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_n6sk1b2l88a__getPerimPlines_(__params__, site_, road_descr_) {
...
async function exec_neighbourhood_node_n6sk1b2l88a__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_n6sk1b2l88a__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_n6sk1b2l88a__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_n6sk1b2l88a__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_n6sk1b2l88a(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let front_edges_ = await exec_neighbourhood_node_n6sk1b2l88a_getFrontEdges_(__params__, cluster_);
if (__params__.terminated) { return __params__.model;}

let remainder_ = await exec_neighbourhood_node_n6sk1b2l88a_trimClusterDepth_(__params__, cluster_, front_edges_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fvux7ub6ibw_processCluster_(__params__, cluster_, cluster_counts_) {

let new_parts_list_ = [];

let area_ = __modules__.calc.Area( __params__.model, cluster_ );

let front_edges_ = await exec_neighbourhood_node_fvux7ub6ibw__getFrontEdges_(__params__, cluster_);
if (__params__.terminated) { return __params__.model;}

if (area_ > (part_og_d_ * part_og_w_ * 2)){

let new_parts_lists_ = await exec_neighbourhood_node_fvux7ub6ibw__subdivFrontEdges_(__params__, cluster_, front_edges_, cluster_counts_);
if (__params__.terminated) { return __params__.model;}
...
let front_edge_ = await exec_neighbourhood_node_fvux7ub6ibw__getLongestEdge_(__params__, front_edges_);
if (__params__.terminated) { return __params__.model;}

let cen_ = __modules__.calc.Centroid( __params__.model, front_edge_, 'ps_average' );

let edge_ = await exec_neighbourhood_node_fvux7ub6ibw__touchingEdge_(__params__, cluster_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fvux7ub6ibw__getLongestEdge_(__params__, edges_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__getFrontEdges_(__params__, cluster_) {

let pline_ = await exec_neighbourhood_node_fvux7ub6ibw__getPerimPlines_(__params__, cluster_, "loc");
if (__params__.terminated) { return __params__.model;}

if (len(pline_) == 0){

pline_ = await exec_neighbourhood_node_fvux7ub6ibw__getPerimPlines_(__params__, cluster_, "sec");
if (__params__.terminated) { return __params__.model;}
}

if (len(pline_) == 0){

pline_ = await exec_neighbourhood_node_fvux7ub6ibw__getPerimPlines_(__params__, cluster_, "art");
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_fvux7ub6ibw__subdivFrontEdges_(__params__, cluster_, front_edges_, cluster_counts_) {
...
let pgon1_ = await exec_neighbourhood_node_fvux7ub6ibw__makePgonFromRays_(__params__, ray0_, ray1_);
if (__params__.terminated) { return __params__.model;}
...
let pgon2_ = await exec_neighbourhood_node_fvux7ub6ibw__makePgonFromRays_(__params__, ray0_, ray1_);
if (__params__.terminated) { return __params__.model;}
...
let whites_ = await exec_neighbourhood_node_fvux7ub6ibw__filterAndSortParts_(__params__, two_parts_, entr_);
if (__params__.terminated) { return __params__.model;}
...
let edge_ = await exec_neighbourhood_node_fvux7ub6ibw__touchingEdge_(__params__, part0_edges_, __modules__.attrib.Get(__params__.model, part0_, 'entr'));
if (__params__.terminated) { return __params__.model;}
...
cluster_counts_["og_clus1"] = cluster_counts_["og_clus1"] + 1;
}

else {
if(len(two_parts_) > 1){

cluster_counts_["og_clus2"] = cluster_counts_["og_clus2"] + 1;
}
}
...
await exec_neighbourhood_node_fvux7ub6ibw__attribs_(__params__, cluster_, new_parts_list_, white_parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fvux7ub6ibw__attribs_(__params__, cluster_, new_parts_list_, white_parts_) {

for (let  two_parts_ of new_parts_list_){

await exec_neighbourhood_node_fvux7ub6ibw__copyAttribs_(__params__, cluster_, listFlat(two_parts_));
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_fvux7ub6ibw__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', cluster_), __modules__.query.Get(__params__.model, '_e', all_parts_));
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_fvux7ub6ibw__transferEdgeAttribsBtwTouchingParts_(__params__, all_parts_);
if (__params__.terminated) { return __params__.model;}
}


async function exec_neighbourhood_node_fvux7ub6ibw__makePgonFromRays_(__params__, ray0_, ray1_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__filterAndSortParts_(__params__, two_parts_, entr_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__getPerimPlines_(__params__, site_, road_descr_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_fvux7ub6ibw__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fvux7ub6ibw__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__project_(__params__, ray_, rays_, max_dist_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__isect_(__params__, ray_, rays_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_fvux7ub6ibw(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);

let clusters_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "off_grid");

let all_parts_loc_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "loc");

let all_parts_sec_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "sec");

let cluster_counts_ = {};

cluster_counts_['og_clus1'] = 0;

cluster_counts_['og_clus2'] = 0;

for (let  cluster_ of clusters_){

let new_parts_list_ = await exec_neighbourhood_node_fvux7ub6ibw_processCluster_(__params__, cluster_, cluster_counts_);
if (__params__.terminated) { return __params__.model;}
}

__modules__.attrib.Set(__params__.model, null, 'og_clus1_on_loc_num',  cluster_counts_['og_clus1'] );

__modules__.attrib.Set(__params__.model, null, 'og_clus2_on_loc_num',  cluster_counts_['og_clus2'] );

__modules__.attrib.Set(__params__.model, null, 'og_clus1_on_loc_con',  cluster_counts_['og_clus1'] * part_og_d_ );

__modules__.attrib.Set(__params__.model, null, 'og_clus2_on_loc_con',  cluster_counts_['og_clus2'] * part_og_d_ );
__modules__._model.__postprocess__( __params__.model);
break; }
return __params__.model;
}
...
async function exec_neighbourhood_node_bgur6o37386_mergeParts_(__params__, parts_, expected_areas_) {
...
let new_part_ = await exec_neighbourhood_node_bgur6o37386__mergeWithNeighbour_(__params__, part_, parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_bgur6o37386_getLongestEdge_(__params__, edges_) {
...
async function exec_neighbourhood_node_bgur6o37386__mergeWithNeighbour_(__params__, part_, parts_) {
...
let nedge_ = await exec_neighbourhood_node_bgur6o37386__getNeighbourEdge_(__params__, edge_, parts_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_bgur6o37386__removeCracks_(__params__, posis_);
if (__params__.terminated) { return __params__.model;}

let new_part_ = __modules__.make.Polygon( __params__.model, posis_ );

await exec_neighbourhood_node_bgur6o37386__copyAttribs_(__params__, npart_, new_part_);
if (__params__.terminated) { return __params__.model;}

let old_parts_ = listFlat([part_, npart_]);

await exec_neighbourhood_node_bgur6o37386__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', old_parts_), __modules__.query.Get(__params__.model, '_e', new_part_));
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_bgur6o37386__removeCracks_(__params__, posis_) {
...
async function exec_neighbourhood_node_bgur6o37386__getNeighbourEdge_(__params__, edge_, parts_) {
...
async function exec_neighbourhood_node_bgur6o37386__copyAttribs_(__params__, pgon_from_, pgon_to_) {
...
async function exec_neighbourhood_node_bgur6o37386__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_bgur6o37386__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_bgur6o37386__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_bgur6o37386__cleanPgonsAng_(__params__, pgons_) {
...
let dot_ = await exec_neighbourhood_node_bgur6o37386__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_bgur6o37386__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_bgur6o37386(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let new_parts1_ = await exec_neighbourhood_node_bgur6o37386_mergeParts_(__params__, parts_, expected_areas_);
if (__params__.terminated) { return __params__.model;}

parts_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "off_grid1");

let new_parts2_ = await exec_neighbourhood_node_bgur6o37386_mergeParts_(__params__, parts_, expected_areas_);
if (__params__.terminated) { return __params__.model;}
...
new_parts_ = await exec_neighbourhood_node_bgur6o37386__cleanPgonsAng_(__params__, new_parts_);
if (__params__.terminated) { return __params__.model;}
...
let front_edge_ = await exec_neighbourhood_node_bgur6o37386_getLongestEdge_(__params__, front_edges_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_pd0yb9y8m6l(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_6s7bq59zp8a_processBlock_(__params__, block_) {

let roads_art_ = await exec_neighbourhood_node_6s7bq59zp8a__getSitePlines_(__params__, block_, "road_art");
if (__params__.terminated) { return __params__.model;}

let roads_sec_ = await exec_neighbourhood_node_6s7bq59zp8a__getSitePlines_(__params__, block_, "road_sec");
if (__params__.terminated) { return __params__.model;}

let result_ = await exec_neighbourhood_node_6s7bq59zp8a__createOnGridStrips_(__params__, block_, roads_art_, roads_sec_, []);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_6s7bq59zp8a__createOnGridStrips_(__params__, block_, roads_art_, roads_sec_, roads_loc_) {
...
await exec_neighbourhood_node_6s7bq59zp8a__transferEdgeAttribsBtwTouchingParts_(__params__, new_parts_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_6s7bq59zp8a__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', block_), __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, '_e', new_parts_), ['road', null], '==', null));
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_6s7bq59zp8a__copyAttribs_(__params__, block_, new_parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_6s7bq59zp8a__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_6s7bq59zp8a__cleanPgons_(__params__, pgons_) {

for (let  pgon_ of pgons_){

await exec_neighbourhood_node_6s7bq59zp8a__cleanPgonEdge_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_6s7bq59zp8a__cleanPgonAng_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_6s7bq59zp8a__cleanPgonEdge_(__params__, pgon_) {
...
async function exec_neighbourhood_node_6s7bq59zp8a__cleanPgonAng_(__params__, pgon_) {

let del_posis_ = [];

for (let  vert_ of __modules__.query.Get(__params__.model, '_v', pgon_)){

let dot_ = await exec_neighbourhood_node_6s7bq59zp8a__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_6s7bq59zp8a__getSitePlines_(__params__, site_, road_descr_) {
...
async function exec_neighbourhood_node_6s7bq59zp8a__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_6s7bq59zp8a__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_6s7bq59zp8a__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_6s7bq59zp8a__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_6s7bq59zp8a__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_6s7bq59zp8a(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let result_ = await exec_neighbourhood_node_6s7bq59zp8a_processBlock_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_yut8a8x67s_createOnGridCorners_(__params__, block_) {

let roads_loc_ = await exec_neighbourhood_node_yut8a8x67s__getSitePlines_(__params__, block_, "road_loc");
if (__params__.terminated) { return __params__.model;}
...
__modules__.attrib.Set(__params__.model, back_, 'type',  'white' );

let new_parts_ = listFlat([corner_, back_]);

await exec_neighbourhood_node_yut8a8x67s__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', block_), __modules__.query.Get(__params__.model, '_e', new_parts_));
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_yut8a8x67s__transferEdgeAttribsBtwTouchingParts_(__params__, new_parts_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_yut8a8x67s__copyAttribs_(__params__, block_, new_parts_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_yut8a8x67s__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_yut8a8x67s__cleanPgons_(__params__, pgons_) {

for (let  pgon_ of pgons_){

await exec_neighbourhood_node_yut8a8x67s__cleanPgonEdge_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_yut8a8x67s__cleanPgonAng_(__params__, pgon_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_yut8a8x67s__cleanPgonEdge_(__params__, pgon_) {
...
async function exec_neighbourhood_node_yut8a8x67s__cleanPgonAng_(__params__, pgon_) {

let del_posis_ = [];

for (let  vert_ of __modules__.query.Get(__params__.model, '_v', pgon_)){

let dot_ = await exec_neighbourhood_node_yut8a8x67s__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_yut8a8x67s__getSitePlines_(__params__, site_, road_descr_) {
...
async function exec_neighbourhood_node_yut8a8x67s__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_yut8a8x67s__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_yut8a8x67s__transferEdgeAttribsBtwTouchingParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_yut8a8x67s__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_yut8a8x67s__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_yut8a8x67s(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let new_parts_ = await exec_neighbourhood_node_yut8a8x67s_createOnGridCorners_(__params__, block_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_fzi1kh9qotd(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_rom187sf79(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_mww3dvuraq_getFrontEdges_(__params__, part_) {
...
let edges_loc_ = await exec_neighbourhood_node_mww3dvuraq__getParaPerpEdges_(__params__, __modules__.query.Filter(__params__.model, part_e_, ['road', null], '==', "loc"), swap_orientation_);
if (__params__.terminated) { return __params__.model;}
...
edges_sec_ = await exec_neighbourhood_node_mww3dvuraq__getParaPerpEdges_(__params__, __modules__.query.Filter(__params__.model, part_e_, ['road', null], '==', "sec"), swap_orientation_);
if (__params__.terminated) { return __params__.model;}
...
edges_art_ = await exec_neighbourhood_node_mww3dvuraq__getParaPerpEdges_(__params__, __modules__.query.Filter(__params__.model, part_e_, ['road', null], '==', "art"), swap_orientation_);
if (__params__.terminated) { return __params__.model;}
...
let edge_ = await exec_neighbourhood_node_mww3dvuraq__closestEdge_(__params__, edge_acc_, cen_);
if (__params__.terminated) { return __params__.model;}
...
edges_ = await exec_neighbourhood_node_mww3dvuraq__getCrvEdges_(__params__, edge_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_mww3dvuraq_getNeigh_(__params__, edge_, neigh_edges_) {

let cen_ = __modules__.calc.Centroid( __params__.model, edge_, 'ps_average' );

let neigh_edge_ = await exec_neighbourhood_node_mww3dvuraq__touchingEdge_(__params__, neigh_edges_, cen_);
if (__params__.terminated) { return __params__.model;}

return __modules__.query.Get(__params__.model, 'pg', neigh_edge_)[pythonList(0, __modules__.query.Get(__params__.model, 'pg', neigh_edge_).length)];
}


async function exec_neighbourhood_node_mww3dvuraq__getParaPerpEdges_(__params__, edges_, swap_orientation_) {
...
async function exec_neighbourhood_node_mww3dvuraq__getCrvEdges_(__params__, edge_) {

let part_edges_ = __modules__.query.Get(__params__.model, '_e',  __modules__.query.Get(__params__.model, 'pg', edge_));

let crv_edges_ = [edge_];

let idx_ = listFind(part_edges_, edge_);

let next_edge_ = edge_;

for (let  i_ of range(len(part_edges_))){

let vert_ = __modules__.query.Get(__params__.model, '_v', next_edge_)[pythonList(1, __modules__.query.Get(__params__.model, '_v', next_edge_).length)];

let edge_road_ = __modules__.attrib.Get(__params__.model, edge_, 'road');

let ang_ = await exec_neighbourhood_node_mww3dvuraq__vertAng_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}

if (abs(ang_ - 180) < 45){

next_edge_ = __modules__.query.Get(__params__.model, '_e', vert_)[pythonList(1, __modules__.query.Get(__params__.model, '_e', vert_).length)];

__modules__.list.Add( crv_edges_, next_edge_, 'to_end' );
}
...
vert_ = __modules__.query.Get(__params__.model, '_v', next_edge_)[pythonList(0, __modules__.query.Get(__params__.model, '_v', next_edge_).length)];

edge_road_ = __modules__.attrib.Get(__params__.model, edge_, 'road');

ang_ = await exec_neighbourhood_node_mww3dvuraq__vertAng_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}

if (abs(ang_ - 180) < 45){

next_edge_ = __modules__.query.Get(__params__.model, '_e', vert_)[pythonList(0, __modules__.query.Get(__params__.model, '_e', vert_).length)];
...
async function exec_neighbourhood_node_mww3dvuraq__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_mww3dvuraq__closestEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_mww3dvuraq__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_mww3dvuraq(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let parts_og_ = listJoin(parts_og0_, parts_og1_);

let parts_white_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "white");

let parts_loc_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "loc");

let parts_sec_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "sec");

let parts_loc_sec_ = listJoin(parts_loc_, parts_sec_);

for (let  part_og_ of parts_og_){

let block_parts_ls_ = __modules__.query.Filter(__params__.model, parts_loc_sec_, ['block_id', null], '==',  __modules__.attrib.Get(__params__.model, part_og_, 'block_id'));

let block_parts_ls_e_ = __modules__.query.Get(__params__.model, '_e', block_parts_ls_);

let edges_ = await exec_neighbourhood_node_mww3dvuraq_getFrontEdges_(__params__, part_og_);
if (__params__.terminated) { return __params__.model;}

for (let  edge_ of edges_){

let part_ls_ = await exec_neighbourhood_node_mww3dvuraq_getNeigh_(__params__, edge_, block_parts_ls_e_);
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, edge_, 'neigh',  part_ls_ );

__modules__.attrib.Set(__params__.model, edge_, 'type',  "front" );
}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_3oyy9it44r6_cenBlk_(__params__, site_name_, parts_, open_req_area_, amen_req_area_) {

let total_open_area_ = 0;

let total_amen_area_ = 0;

let block_id_ = __modules__.attrib.Get( __params__.model, null, site_name_ + "_cen_block_id" );
printFunc(__params__.console,'block_id', block_id_);
...
printFunc(__params__.console,'total_req_area', total_req_area_);

parts_cen_ = __modules__.query.Filter(__params__.model, parts_, ['block_id', null], '==', block_id_);
...
let curr_open_area_ = await exec_neighbourhood_node_3oyy9it44r6__cenBlkAllOpen_(__params__, parts_cen_, open_req_area_);
if (__params__.terminated) { return __params__.model;}

total_open_area_ = total_open_area_ + curr_open_area_;
}

else {
if(cen_area_ < total_req_area_){

let result_ = await exec_neighbourhood_node_3oyy9it44r6__cenBlkOpenAndAmen_(__params__, parts_cen_, site_cen_, open_req_area_, amen_req_area_);
if (__params__.terminated) { return __params__.model;}

total_open_area_ = total_open_area_ + result_[pythonList(0, result_.length)];

total_amen_area_ = total_amen_area_ + result_[pythonList(1, result_.length)];
}
...
let result_ = await exec_neighbourhood_node_3oyy9it44r6__cenBlkMixed_(__params__, parts_cen_, site_cen_, open_req_area_, amen_req_area_, resi_req_area_);
if (__params__.terminated) { return __params__.model;}
...
let x_ = "==============================";
printFunc(__params__.console,'x', x_);

return [total_open_area_, total_amen_area_, parts_cen_];
}


async function exec_neighbourhood_node_3oyy9it44r6__cenBlkAllOpen_(__params__, parts_, open_req_area_) {

let areas_ = __modules__.calc.Area( __params__.model, parts_ );

let curr_open_area_ = sum(areas_);

await exec_neighbourhood_node_3oyy9it44r6__makeOpen_(__params__, parts_);
if (__params__.terminated) { return __params__.model;}

let result_open_ = await exec_neighbourhood_node_3oyy9it44r6__printStr_(__params__, curr_open_area_, open_req_area_);
if (__params__.terminated) { return __params__.model;}
printFunc(__params__.console,'result_open', result_open_);

return curr_open_area_;
}


async function exec_neighbourhood_node_3oyy9it44r6__cenBlkOpenAndAmen_(__params__, parts_, site_cen_, open_req_area_, amen_req_area_) {

let parts_cen_ = await exec_neighbourhood_node_3oyy9it44r6__sortPartsStrightDistToCen_(__params__, parts_, site_cen_);
if (__params__.terminated) { return __params__.model;}

parts_cen_ = listRev(parts_cen_);

let result_ = await exec_neighbourhood_node_3oyy9it44r6__divParts_(__params__, parts_cen_);
if (__params__.terminated) { return __params__.model;}

let parts_cor_ = result_[pythonList(0, result_.length)];

let parts_side_ = result_[pythonList(1, result_.length)].slice(0,-1);

let curr_amen_area_ = 0;

let curr_amen_ = [];

curr_amen_area_ = await exec_neighbourhood_node_3oyy9it44r6__addPartsUntilReqArea_(__params__, curr_amen_, parts_side_, curr_amen_area_, amen_req_area_);
if (__params__.terminated) { return __params__.model;}

let neighbours_ = __modules__.query.Neighbor( __params__.model, 'pg', curr_amen_ );

let corners_ = await exec_neighbourhood_node_3oyy9it44r6__filterKeepCorners_(__params__, neighbours_);
if (__params__.terminated) { return __params__.model;}

curr_amen_area_ = await exec_neighbourhood_node_3oyy9it44r6__addParts_(__params__, curr_amen_, corners_, curr_amen_area_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_3oyy9it44r6__makeAmen_(__params__, curr_amen_);
if (__params__.terminated) { return __params__.model;}

let parts_remainder_ = await exec_neighbourhood_node_3oyy9it44r6__filterRem_(__params__, parts_, curr_amen_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_3oyy9it44r6__makeOpen_(__params__, parts_remainder_);
if (__params__.terminated) { return __params__.model;}
...
let result_amen_ = await exec_neighbourhood_node_3oyy9it44r6__printStr_(__params__, curr_amen_area_, amen_req_area_);
if (__params__.terminated) { return __params__.model;}
printFunc(__params__.console,'result_amen', result_amen_);

return [curr_open_area_, curr_amen_area_];
}


async function exec_neighbourhood_node_3oyy9it44r6__cenBlkMixed_(__params__, parts_, site_cen_, open_req_area_, amen_req_area_, resi_req_area_) {
...
let parts_side_remainder_ = await exec_neighbourhood_node_3oyy9it44r6__filterRem_(__params__, parts_side_, curr_amen_);
if (__params__.terminated) { return __params__.model;}

let neighbours_ = __modules__.query.Neighbor( __params__.model, 'pg', curr_amen_ );

let amen_corners_ = await exec_neighbourhood_node_3oyy9it44r6__filterKeepCorners_(__params__, neighbours_);
if (__params__.terminated) { return __params__.model;}

curr_amen_area_ = await exec_neighbourhood_node_3oyy9it44r6__addParts_(__params__, curr_amen_, amen_corners_, curr_amen_area_);
if (__params__.terminated) { return __params__.model;}
...
curr_resi_area_ = await exec_neighbourhood_node_3oyy9it44r6__addPartsUntilReqArea_(__params__, curr_resi_, parts_side_remainder_, curr_resi_area_, resi_req_area_);
if (__params__.terminated) { return __params__.model;}

neighbours_ = __modules__.query.Neighbor( __params__.model, 'pg', curr_resi_ );

let resi_corners_ = await exec_neighbourhood_node_3oyy9it44r6__filterKeepCorners_(__params__, neighbours_);
if (__params__.terminated) { return __params__.model;}

resi_corners_ = await exec_neighbourhood_node_3oyy9it44r6__filterRem_(__params__, resi_corners_, amen_corners_);
if (__params__.terminated) { return __params__.model;}

curr_resi_area_ = await exec_neighbourhood_node_3oyy9it44r6__addParts_(__params__, curr_resi_, resi_corners_, curr_resi_area_);
if (__params__.terminated) { return __params__.model;}

if (curr_resi_area_ < resi_req_area_){

curr_resi_area_ = await exec_neighbourhood_node_3oyy9it44r6__addPartsUntilReqArea_(__params__, curr_resi_, parts_og_, curr_resi_area_, resi_req_area_);
if (__params__.terminated) { return __params__.model;}
}

let parts_remainder_ = await exec_neighbourhood_node_3oyy9it44r6__filterRem_(__params__, parts_, curr_resi_);
if (__params__.terminated) { return __params__.model;}

parts_remainder_ = await exec_neighbourhood_node_3oyy9it44r6__filterRem_(__params__, parts_remainder_, curr_amen_);
if (__params__.terminated) { return __params__.model;}
...
let result_resi_ = await exec_neighbourhood_node_3oyy9it44r6__printStr_(__params__, curr_resi_area_, resi_req_area_);
if (__params__.terminated) { return __params__.model;}
printFunc(__params__.console,'result_resi', result_resi_);

return [curr_open_area_, curr_amen_area_];
}


async function exec_neighbourhood_node_3oyy9it44r6__printStr_(__params__, curr_, req_) {
...
async function exec_neighbourhood_node_3oyy9it44r6__sortPartsStrightDistToCen_(__params__, parts_, site_cen_) {
...
async function exec_neighbourhood_node_3oyy9it44r6__sortPartsDistToPark_(__params__, parts_, main_park_) {

let main_park_hull_ = __modules__.poly2d.ConvexHull( __params__.model, main_park_ );
...
let edge_dist_ = await exec_neighbourhood_node_3oyy9it44r6__distToPark_(__params__, part_, main_park_hull_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_3oyy9it44r6__distToPark_(__params__, part_, park_) {
...
async function exec_neighbourhood_node_3oyy9it44r6__divParts_(__params__, parts_) {
...
async function exec_neighbourhood_node_3oyy9it44r6__addPartsUntilReqArea_(__params__, curr_list_, parts_to_add_, curr_area_, req_area_) {

curr_area_ = curr_area_;
...
async function exec_neighbourhood_node_3oyy9it44r6__addParts_(__params__, curr_list_, parts_to_add_, curr_area_) {
...
async function exec_neighbourhood_node_3oyy9it44r6__makeOpen_(__params__, parts_) {

for (let  part_ of parts_){

__modules__.attrib.Set(__params__.model, part_, 'type',  __modules__.attrib.Get(__params__.model, part_, 'type')+ "_os" );
...
async function exec_neighbourhood_node_3oyy9it44r6__makeAmen_(__params__, parts_) {

for (let  part_ of parts_){

__modules__.attrib.Set(__params__.model, part_, 'type',  __modules__.attrib.Get(__params__.model, part_, 'type')+ "_am" );
...
async function exec_neighbourhood_node_3oyy9it44r6__filterKeepCorners_(__params__, parts_) {
...
async function exec_neighbourhood_node_3oyy9it44r6__filterRem_(__params__, parts_, parts_to_rem_) {
...
async function exec_neighbourhood_node_3oyy9it44r6(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let result_ = await exec_neighbourhood_node_3oyy9it44r6_cenBlk_(__params__, site_name_, parts_, req_open_area_, req_amen_area_);
if (__params__.terminated) { return __params__.model;}
...
let parts_cen_ = result_[pythonList(2, result_.length)];

let site_cen_ = __modules__.attrib.Get( __params__.model, null, site_name_ + "_cen" );

let parts_loc_ = __modules__.query.Filter(__params__.model, parts_, ['type', null], '==', "loc");

let parts_loc_loc_ = __modules__.query.Filter(__params__.model, parts_, ['type', null], '==', "loc_loc");

let amen_parts_ = listJoin(parts_loc_, parts_loc_loc_);

if (curr_amen_area_ < req_amen_area_){

amen_parts_ = await exec_neighbourhood_node_3oyy9it44r6__sortPartsStrightDistToCen_(__params__, amen_parts_, site_cen_);
if (__params__.terminated) { return __params__.model;}

for (let  part_ of amen_parts_){

let area_ = __modules__.calc.Area( __params__.model, part_ );

curr_amen_area_ = curr_amen_area_ + area_;
...
await exec_neighbourhood_node_3oyy9it44r6__makeAmen_(__params__, [part_]);
if (__params__.terminated) { return __params__.model;}
}
}

let parts_og0_ = __modules__.query.Filter(__params__.model, parts_, ['type', null], '==', "off_grid0");

let parts_og1_ = __modules__.query.Filter(__params__.model, parts_, ['type', null], '==', "off_grid1");

let open_parts_ = listJoin(parts_og0_, parts_og1_);

if (curr_open_area_ < req_open_area_){

if (len(parts_cen_) > 0){

open_parts_ = await exec_neighbourhood_node_3oyy9it44r6__sortPartsDistToPark_(__params__, open_parts_, parts_cen_);
if (__params__.terminated) { return __params__.model;}

open_parts_ = listZip(open_parts_)[pythonList(0, listZip(open_parts_).length)];
}

else {

open_parts_ = await exec_neighbourhood_node_3oyy9it44r6__sortPartsStrightDistToCen_(__params__, open_parts_, site_cen_);
if (__params__.terminated) { return __params__.model;}
}

for (let  part_ of open_parts_){

let area_ = __modules__.calc.Area( __params__.model, part_ );

curr_open_area_ = curr_open_area_ + area_;
...
await exec_neighbourhood_node_3oyy9it44r6__makeOpen_(__params__, [part_]);
if (__params__.terminated) { return __params__.model;}
}
}
}
...
async function exec_neighbourhood_node_hufy15hg81_createPath_(__params__, part_, parts_ls_) {
...
let path_ray_ = await exec_neighbourhood_node_hufy15hg81__getPathRay_(__params__, part_);
if (__params__.terminated) { return __params__.model;}

let path_cline_ = await exec_neighbourhood_node_hufy15hg81__creatAccessPathCline_(__params__, part_, block_parts_ls_edges_, path_ray_);
if (__params__.terminated) { return __params__.model;}

__modules__.attrib.Set(__params__.model, part_, 'cluster_type',  __modules__.attrib.Get(__params__.model, parts_ls_[pythonList(0, parts_ls_.length)], 'type') );

if (path_cline_ != null){

__modules__.attrib.Set(__params__.model, part_, 'cluster_type',  __modules__.attrib.Get(__params__.model, path_cline_, 'type') );

__modules__.attrib.Set(__params__.model, part_, 'entr',  __modules__.attrib.Get(__params__.model,  __modules__.query.Get(__params__.model, 'ps', path_cline_)[pythonList(0, __modules__.query.Get(__params__.model, 'ps', path_cline_).length)], 'xyz') );
}
...
async function exec_neighbourhood_node_hufy15hg81_cutPaths_(__params__, path_clines_, part_, cluster_type_) {
...
await exec_neighbourhood_node_hufy15hg81__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', part_), parts2_edges_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_hufy15hg81__transferEdgeAttribsTouchingPart_(__params__, __modules__.query.Get(__params__.model, '_e', path_pgons_trim_), parts2_edges_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_hufy15hg81__copyAttribs_(__params__, part_, parts2_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_hufy15hg81__convertPartToQuad_(__params__, part_) {
...
await exec_neighbourhood_node_hufy15hg81__transferEdgeAttribsClosest_(__params__, part_edges_, __modules__.query.Get(__params__.model, '_e', quad_));
if (__params__.terminated) { return __params__.model;}
...
let dot_ = await exec_neighbourhood_node_hufy15hg81__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_hufy15hg81__trimPgon_(__params__, base_, pgons_) {
...
async function exec_neighbourhood_node_hufy15hg81__getPathRay_(__params__, part_) {
...
front_edge_ = await exec_neighbourhood_node_hufy15hg81__getFrontEdge_(__params__, part_e_, cen_, swap_orientation_);
if (__params__.terminated) { return __params__.model;}
}
...
async function exec_neighbourhood_node_hufy15hg81__getFrontEdge_(__params__, part_e_, cen_, swap_orientation_) {

let edges_loc_ = await exec_neighbourhood_node_hufy15hg81__getParaPerpEdges_(__params__, __modules__.query.Filter(__params__.model, part_e_, ['road', null], '==', "loc"), swap_orientation_);
if (__params__.terminated) { return __params__.model;}
...
edges_sec_ = await exec_neighbourhood_node_hufy15hg81__getParaPerpEdges_(__params__, __modules__.query.Filter(__params__.model, part_e_, ['road', null], '==', "sec"), swap_orientation_);
if (__params__.terminated) { return __params__.model;}
...
edges_art_ = await exec_neighbourhood_node_hufy15hg81__getParaPerpEdges_(__params__, __modules__.query.Filter(__params__.model, part_e_, ['road', null], '==', "art"), swap_orientation_);
if (__params__.terminated) { return __params__.model;}
...
let edge_ = await exec_neighbourhood_node_hufy15hg81__closestEdge_(__params__, edge_acc_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_hufy15hg81__getParaPerpEdges_(__params__, edges_, swap_orientation_) {
...
async function exec_neighbourhood_node_hufy15hg81__creatAccessPathCline_(__params__, part_, ls_edges_, path_ray_) {
...
let result0_ = await exec_neighbourhood_node_hufy15hg81_isect_(__params__, path_ray_, non_road_rays_);
if (__params__.terminated) { return __params__.model;}
...
let result1_ = await exec_neighbourhood_node_hufy15hg81_isect_(__params__, path_ray2_, road_rays_);
if (__params__.terminated) { return __params__.model;}
...
__modules__.attrib.Set(__params__.model, path_cline_, 'type',  __modules__.attrib.Get(__params__.model, loc_part_, 'type') );
...
async function exec_neighbourhood_node_hufy15hg81__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_hufy15hg81__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_hufy15hg81__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_hufy15hg81__closestEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_hufy15hg81__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_hufy15hg81__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_hufy15hg81__transferEdgeAttribsClosest_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_hufy15hg81__closestEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_hufy15hg81__transferEdgeAttribsTouchingPart_(__params__, from_edges_, to_edges_) {
...
async function exec_neighbourhood_node_hufy15hg81__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_hufy15hg81_isect_(__params__, ray_, rays_) {
...
async function exec_neighbourhood_node_hufy15hg81(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let parts_xx_ = listFlat([parts_og0_, parts_og1_, parts_white_]);
...
for (let  part_ of parts_xx_){

let area_ = __modules__.calc.Area( __params__.model, part_ );

if (area_ < (part_og_d_ * part_og_w_ * 0.5)){

__modules__.attrib.Set(__params__.model, part_, 'type',  "white" );

continue;
}

let cline_ = await exec_neighbourhood_node_hufy15hg81_createPath_(__params__, part_, parts_loc_);
if (__params__.terminated) { return __params__.model;}

if (cline_ == null){

cline_ = await exec_neighbourhood_node_hufy15hg81_createPath_(__params__, part_, parts_sec_);
if (__params__.terminated) { return __params__.model;}
}

if (cline_ == null){

cline_ = await exec_neighbourhood_node_hufy15hg81_createPath_(__params__, part_, parts_art_);
if (__params__.terminated) { return __params__.model;}
}
...
let cut_ = await exec_neighbourhood_node_hufy15hg81_cutPaths_(__params__, path_clines_, part_lsa_, __modules__.attrib.Get(__params__.model, part_lsa_, 'type'));
if (__params__.terminated) { return __params__.model;}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_96mwqabz8q_addAttribsCrvRoads_(__params__, parts_) {

for (let  part_ of parts_){

let part_edges_ = __modules__.query.Get(__params__.model, '_e', part_);

let art_ = await exec_neighbourhood_node_96mwqabz8q__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_art");
if (__params__.terminated) { return __params__.model;}

let sec_ = await exec_neighbourhood_node_96mwqabz8q__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_sec");
if (__params__.terminated) { return __params__.model;}

let loc_ = await exec_neighbourhood_node_96mwqabz8q__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_loc");
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_96mwqabz8q__getCrvRoadEdgeTypes_(__params__, part_edges_, road_descr_) {
...
let ang_ = await exec_neighbourhood_node_96mwqabz8q__vertAng_(__params__, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)])[pythonList(0, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)]).length)]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_96mwqabz8q__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_96mwqabz8q(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
async function exec_neighbourhood_node_2phj4uf1mgw_slicePartIntoPlots_(__params__, part_, road_descr_, width_, depth_) {

let road_edges_ = await exec_neighbourhood_node_2phj4uf1mgw__getRoadEdges_(__params__, part_, road_descr_);
if (__params__.terminated) { return __params__.model;}
...
let ang_ = await exec_neighbourhood_node_2phj4uf1mgw__vertAng_(__params__, __modules__.query.Get(__params__.model, '_v', road_edges_[pythonList(0, road_edges_.length)])[pythonList(1, __modules__.query.Get(__params__.model, '_v', road_edges_[pythonList(0, road_edges_.length)]).length)]);
if (__params__.terminated) { return __params__.model;}
...
let ang_ = await exec_neighbourhood_node_2phj4uf1mgw__vertAng_(__params__, __modules__.query.Get(__params__.model, '_v', road_edges_[pythonList(-1, road_edges_.length)])[pythonList(0, __modules__.query.Get(__params__.model, '_v', road_edges_[pythonList(-1, road_edges_.length)]).length)]);
if (__params__.terminated) { return __params__.model;}
...
let isect_result_ = await exec_neighbourhood_node_2phj4uf1mgw__isect_(__params__, ray_perp_, other_edges_, []);
if (__params__.terminated) { return __params__.model;}
...
let plot_ = await exec_neighbourhood_node_2phj4uf1mgw__makeLot_(__params__, all_edges_, cut0_, cut1_);
if (__params__.terminated) { return __params__.model;}
...
let ang_ = await exec_neighbourhood_node_2phj4uf1mgw__vertAng_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
let isect_result_ = await exec_neighbourhood_node_2phj4uf1mgw__isect_(__params__, ray_cut_, other_edges_, []);
if (__params__.terminated) { return __params__.model;}
...
let plot_ = await exec_neighbourhood_node_2phj4uf1mgw__makeLot_(__params__, all_edges_, cut1_, null);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_2phj4uf1mgw__transferEdgeAttribs_(__params__, __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, '_e', part_), ['road', null], '!=', null), __modules__.query.Get(__params__.model, '_e', plots_));
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_2phj4uf1mgw__copyAttribs_(__params__, part_, plots_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2phj4uf1mgw_addTypeAttribsCrvRoads_(__params__, plots_) {

for (let  plot_ of plots_){

let part_edges_ = __modules__.query.Get(__params__.model, '_e', plot_);

let art_ = await exec_neighbourhood_node_2phj4uf1mgw__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_art");
if (__params__.terminated) { return __params__.model;}

let sec_ = await exec_neighbourhood_node_2phj4uf1mgw__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_sec");
if (__params__.terminated) { return __params__.model;}

let loc_ = await exec_neighbourhood_node_2phj4uf1mgw__getCrvRoadEdgeTypes_(__params__, part_edges_, "road_loc");
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2phj4uf1mgw_addOrientAttribs_(__params__, plots_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw__copyAttribs_(__params__, pgon_from_, pgons_to_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw__makeLot_(__params__, part_edges_, cut0_, cut1_) {
...
let posis_list_ = await exec_neighbourhood_node_2phj4uf1mgw__getPosisBetweenEdges_(__params__, part_edges_, cut1_[pythonList(3, cut1_.length)], cut1_[pythonList(2, cut1_.length)]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_2phj4uf1mgw__getPosisBetweenEdges_(__params__, part_edges_, cut0_[pythonList(2, cut0_.length)], cut0_[pythonList(3, cut0_.length)]);
if (__params__.terminated) { return __params__.model;}
...
let posis_list_ = await exec_neighbourhood_node_2phj4uf1mgw__getPosisBetweenEdges_(__params__, part_edges_, cut1_[pythonList(3, cut1_.length)], cut0_[pythonList(3, cut0_.length)]);
if (__params__.terminated) { return __params__.model;}
...
posis_list_ = await exec_neighbourhood_node_2phj4uf1mgw__getPosisBetweenEdges_(__params__, part_edges_, cut0_[pythonList(2, cut0_.length)], cut1_[pythonList(2, cut1_.length)]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2phj4uf1mgw__getRoadEdges_(__params__, part_, road_descr_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw__getPosisBetweenEdges_(__params__, edges_, edge0_, edge1_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw__addTypeAttribs_(__params__, plots_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw__transferEdgeAttribs_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_2phj4uf1mgw__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2phj4uf1mgw__vertAng_(__params__, vert_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw__getCrvRoadEdgeTypes_(__params__, part_edges_, road_descr_) {
...
let ang_ = await exec_neighbourhood_node_2phj4uf1mgw__vertAng_(__params__, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)])[pythonList(0, __modules__.query.Get(__params__.model, '_v', edges_[pythonList(i_, edges_.length)]).length)]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2phj4uf1mgw__isect_(__params__, ray_, edges_, subdivs_) {
...
async function exec_neighbourhood_node_2phj4uf1mgw(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
plots_ = await exec_neighbourhood_node_2phj4uf1mgw_slicePartIntoPlots_(__params__, pgon_, "road_art", plot_art_w_, part_art_d_);
if (__params__.terminated) { return __params__.model;}
}
...
plots_ = await exec_neighbourhood_node_2phj4uf1mgw_slicePartIntoPlots_(__params__, pgon_, "road_sec", plot_sec_w_, part_sec_d_);
if (__params__.terminated) { return __params__.model;}
}
...
plots_ = await exec_neighbourhood_node_2phj4uf1mgw_slicePartIntoPlots_(__params__, pgon_, "road_loc", plot_loc_w_, part_loc_d_);
if (__params__.terminated) { return __params__.model;}
}
...
await exec_neighbourhood_node_2phj4uf1mgw_addTypeAttribsCrvRoads_(__params__, plots_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_2phj4uf1mgw_addOrientAttribs_(__params__, plots_);
if (__params__.terminated) { return __params__.model;}
}
}
__modules__._model.__postprocess__( __params__.model);
...
async function exec_neighbourhood_node_2emb9m2figr_mergeParts_(__params__, parts_, expected_areas_) {
...
let new_part_ = await exec_neighbourhood_node_2emb9m2figr__mergeWithNeighbour_(__params__, part_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2emb9m2figr__mergeWithNeighbour_(__params__, part_) {
...
let nedge_ = await exec_neighbourhood_node_2emb9m2figr__getNeighbourEdge_(__params__, edge_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_2emb9m2figr__removeCracks_(__params__, posis_);
if (__params__.terminated) { return __params__.model;}
...
await exec_neighbourhood_node_2emb9m2figr__copyAttribs_(__params__, npart_, new_part_);
if (__params__.terminated) { return __params__.model;}

await exec_neighbourhood_node_2emb9m2figr__transferEdgeAttribsTouching_(__params__, __modules__.query.Get(__params__.model, '_e', old_parts_), __modules__.query.Get(__params__.model, '_e', new_part_));
if (__params__.terminated) { return __params__.model;}

__modules__.modify.Delete( __params__.model, old_parts_, 'delete_selected' );

let new_parts_ = await exec_neighbourhood_node_2emb9m2figr__cleanPgonsAngs_(__params__, [new_part_]);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2emb9m2figr__removeCracks_(__params__, posis_) {
...
async function exec_neighbourhood_node_2emb9m2figr__getNeighbourEdge_(__params__, edge_) {
...
async function exec_neighbourhood_node_2emb9m2figr__copyAttribs_(__params__, pgon_from_, pgon_to_) {
...
async function exec_neighbourhood_node_2emb9m2figr__transferEdgeAttribsTouching_(__params__, from_edges_, to_edges_) {

for (let  to_edge_ of to_edges_){

let cen_ = __modules__.calc.Centroid( __params__.model, to_edge_, 'ps_average' );

let from_edge_ = await exec_neighbourhood_node_2emb9m2figr__touchingEdge_(__params__, from_edges_, cen_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2emb9m2figr__touchingEdge_(__params__, edges_, xyz_) {
...
async function exec_neighbourhood_node_2emb9m2figr__cleanPgonsAngs_(__params__, pgons_) {
...
let dot_ = await exec_neighbourhood_node_2emb9m2figr__angDot_(__params__, vert_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_2emb9m2figr__angDot_(__params__, vert_) {
...
async function exec_neighbourhood_node_2emb9m2figr(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
await exec_neighbourhood_node_2emb9m2figr_mergeParts_(__params__, parts_, expected_areas_);
if (__params__.terminated) { return __params__.model;}
...
async function exec_neighbourhood_node_clktvp1e1wu(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);

let parts_ = __modules__.query.Get(__params__.model, 'pg', null);

let desire_high_ = vecDiv([208, 64, 1], 255);

let desire_high_dark_ = vecDiv([181, 49, 1], 255);

let desire_high_middle_ = vecDiv([253, 204, 102], 255);

let desire_high_middle_dark_ = vecDiv([252, 180, 44], 255);

let desire_low_middle_ = vecDiv([255, 230, 101], 255);

let desire_low_middle_dark_ = vecDiv([252, 212, 39], 255);

let desire_low_ = vecDiv([170, 220, 230], 255);

let desire_very_low_ = vecDiv([150, 200, 210], 255);

let desire_public_ = vecDiv([204, 229, 127], 255);

let colour_park_ = vecDiv([140, 230, 140], 255);

let colour_path_ = vecDiv([255, 255, 224], 255);

let colour_amenity_ = [1, 0.7, 0.7];

let colors_dict_ = {};

colors_dict_["art"] = desire_high_;

colors_dict_["art_art"] = desire_high_dark_;

colors_dict_["art_sec"] = desire_high_dark_;

colors_dict_["art_loc"] = desire_high_dark_;

colors_dict_["sec"] = desire_high_middle_;

colors_dict_["sec_sec"] = desire_high_middle_dark_;

colors_dict_["sec_loc"] = desire_high_middle_dark_;

colors_dict_["loc"] = desire_low_middle_;

colors_dict_["loc_loc"] = desire_low_middle_dark_;

colors_dict_["off_grid0"] = desire_low_;

colors_dict_["off_grid1"] = desire_low_;

colors_dict_["off_grid2"] = desire_very_low_;

colors_dict_["path0"] = colour_path_;

colors_dict_["path1"] = colour_path_;

colors_dict_["path2"] = colour_path_;

colors_dict_["entr0"] = colour_path_;

colors_dict_["entr1"] = colour_path_;

colors_dict_["green0"] = colour_park_;

colors_dict_["green1"] = colour_park_;

colors_dict_["off_grid0_os"] = colour_park_;

colors_dict_["off_grid1_os"] = colour_park_;

colors_dict_["loc_os"] = colour_park_;

colors_dict_["loc_loc_os"] = colour_park_;

colors_dict_["sec_loc_os"] = colour_park_;

colors_dict_["corner_park"] = colour_park_;

colors_dict_["off_grid0_am"] = colour_amenity_;

colors_dict_["off_grid1_am"] = colour_amenity_;

colors_dict_["loc_am"] = colour_amenity_;

colors_dict_["loc_loc_am"] = colour_amenity_;

colors_dict_["sec_loc_am"] = colour_amenity_;

colors_dict_["off_grid_too_small"] = desire_low_;
...
__modules__.visualize.Color( __params__.model, part_, col_ );
}
}

let concave_ = __modules__.attrib.Get(__params__.model, parts_, 'special');

concave_ = __modules__.query.Filter(__params__.model, parts_, ['special', null], '==', "concave_corner");

__modules__.visualize.Color( __params__.model, __modules__.query.Filter(__params__.model, concave_, ['type', null], '==', "loc_loc"), desire_low_middle_ );

__modules__.visualize.Color( __params__.model, __modules__.query.Filter(__params__.model, concave_, ['type', null], '==', "sec_sec"), desire_high_middle_ );
__modules__._model.__postprocess__( __params__.model);
break; }
return __params__.model;
}
...
async function exec_neighbourhood_node_wy7z9ed12ym(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let og_open_loc_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "off_grid_os");

let amen_loc_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "loc_am");

let og_amen_loc_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "off_grid_am");
...
let lot_art_art_area_ = __modules__.calc.Area( __params__.model, art_art_ );

__modules__.attrib.Set(__params__.model, null, 'lot_art_art_area',  sum(lot_art_art_area_) );

let lot_art_sec_area_ = __modules__.calc.Area( __params__.model, art_sec_ );

__modules__.attrib.Set(__params__.model, null, 'lot_art_sec_area',  sum(lot_art_sec_area_) );

let lot_art_loc_area_ = __modules__.calc.Area( __params__.model, art_loc_ );

__modules__.attrib.Set(__params__.model, null, 'lot_art_loc_area',  sum(lot_art_loc_area_) );

let lot_art_area_ = __modules__.calc.Area( __params__.model, art_ );

__modules__.attrib.Set(__params__.model, null, 'lot_art_area',  sum(lot_art_area_) );

let lot_sec_sec_area_ = __modules__.calc.Area( __params__.model, sec_sec_ );

__modules__.attrib.Set(__params__.model, null, 'lot_sec_sec_area',  sum(lot_sec_sec_area_) );

let lot_sec_loc_area_ = __modules__.calc.Area( __params__.model, sec_loc_ );

__modules__.attrib.Set(__params__.model, null, 'lot_sec_loc_area',  sum(lot_sec_loc_area_) );

let lot_sec_area_ = __modules__.calc.Area( __params__.model, sec_ );

__modules__.attrib.Set(__params__.model, null, 'lot_sec_area',  sum(lot_sec_area_) );

let lot_loc_area_ = __modules__.calc.Area( __params__.model, loc_ );

__modules__.attrib.Set(__params__.model, null, 'lot_loc_area',  sum(lot_loc_area_) );

let lot_loc_loc_area_ = __modules__.calc.Area( __params__.model, loc_loc_ );

__modules__.attrib.Set(__params__.model, null, 'lot_loc_loc_area',  sum(lot_loc_loc_area_) );

let og_clus0_on_art_area_ = __modules__.calc.Area( __params__.model, __modules__.query.Filter(__params__.model, off_grid0_, ['cluster_type', null], '==', "art") );

__modules__.attrib.Set(__params__.model, null, 'og_clus0_on_art_area',  sum(og_clus0_on_art_area_) );

let og_clus0_on_sec_area_ = __modules__.calc.Area( __params__.model, __modules__.query.Filter(__params__.model, off_grid0_, ['cluster_type', null], '==', "sec") );

__modules__.attrib.Set(__params__.model, null, 'og_clus0_on_sec_area',  sum(og_clus0_on_sec_area_) );

let og_clus0_on_loc_area_ = __modules__.calc.Area( __params__.model, __modules__.query.Filter(__params__.model, off_grid0_, ['cluster_type', null], '==', "loc") );

__modules__.attrib.Set(__params__.model, null, 'og_clus0_on_loc_area',  sum(og_clus0_on_loc_area_) );

let og_clus1_on_loc_area_ = __modules__.calc.Area( __params__.model, listFlat(off_grid1_, path1_, green1_) );

__modules__.attrib.Set(__params__.model, null, 'og_clus1_on_loc_area',  sum(og_clus1_on_loc_area_) );

let og_clus2_on_loc_area_ = __modules__.calc.Area( __params__.model, listFlat(off_grid2_, path2_) );

__modules__.attrib.Set(__params__.model, null, 'og_clus2_on_loc_area',  sum(og_clus2_on_loc_area_) );
...
let og_entr0_on_art_area_ = __modules__.calc.Area( __params__.model, __modules__.query.Filter(__params__.model, entr0_, ['cluster_type', null], '==', "art") );

__modules__.attrib.Set(__params__.model, null, 'og_entr0_on_art_area',  sum(og_entr0_on_art_area_) );

let og_entr0_on_sec_area_ = __modules__.calc.Area( __params__.model, __modules__.query.Filter(__params__.model, entr0_, ['cluster_type', null], '==', "sec") );

__modules__.attrib.Set(__params__.model, null, 'og_entr0_on_sec_area',  sum(og_entr0_on_sec_area_) );

let og_entr0_on_loc_area_ = __modules__.calc.Area( __params__.model, __modules__.query.Filter(__params__.model, entr0_, ['cluster_type', null], '==', "loc") );

__modules__.attrib.Set(__params__.model, null, 'og_entr0_on_loc_area',  sum(og_entr0_on_loc_area_) );

let og_entr1_on_loc_area_ = __modules__.calc.Area( __params__.model, __modules__.query.Filter(__params__.model, entr1_, ['cluster_type', null], '==', "loc") );

__modules__.attrib.Set(__params__.model, null, 'og_entr1_on_loc_area',  sum(og_entr1_on_loc_area_) );

let open_loc_loc_area_ = __modules__.calc.Area( __params__.model, open_loc_loc_ );

__modules__.attrib.Set(__params__.model, null, 'open_loc_loc_area',  open_loc_loc_area_ );

let open_loc_area_ = __modules__.calc.Area( __params__.model, open_loc_ );

__modules__.attrib.Set(__params__.model, null, 'open_loc_area',  __modules__.attrib.Get(__params__.model, null, 'open_loc_area')+ sum(open_loc_area_) );

let og_open0_on_loc_area_ = __modules__.calc.Area( __params__.model, og_open_loc_ );

__modules__.attrib.Set(__params__.model, null, 'og_open0_on_loc_area',  0 );

let amen_loc_area_ = __modules__.calc.Area( __params__.model, amen_loc_ );

__modules__.attrib.Set(__params__.model, null, 'amen_loc_area',  amen_loc_area_ );

let og_amen0_on_loc_area_ = __modules__.calc.Area( __params__.model, og_amen_loc_ );

__modules__.attrib.Set(__params__.model, null, 'og_amen0_on_loc_area',  og_amen0_on_loc_area_ );
__modules__._model.__postprocess__( __params__.model);
break; }
return __params__.model;
}
...
async function exec_neighbourhood_node_tbb61z2u4kf(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let parts_og2_ = __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "off_grid2");

let parts_og_ = listFlat([parts_og0_, parts_og1_, parts_og2_]);

for (let  part_ of parts_og_){

if (__modules__.attrib.Get(__params__.model, part_, 'cluster_type')== undefined){

let xx_ = __modules__.make.Extrude( __params__.model, part_, 100, 1, 'quads' );
}
}
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_8x119e8gvbx(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);

__modules__.modify.Delete( __params__.model, __modules__.query.Filter(__params__.model,  __modules__.query.Get(__params__.model, 'pg', null), ['type', null], '==', "north_sign"), 'keep_selected' );
__modules__._model.__postprocess__( __params__.model);
break; }
return __params__.model;
}
...
async function exec_neighbourhood_node_z7ljwgpymsd(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
__modules__._model.__postprocess__( __params__.model);
break; }
...
async function exec_neighbourhood_node_ocysq9x64x8(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
data_["og_open0_on_art_area"] = 0;

data_["og_open0_on_sec_area"] = 0;

data_["og_open0_on_loc_area"] = __modules__.attrib.Get(__params__.model, null, 'og_open0_on_loc_area');

data_["og_open1_on_loc_area"] = 0;

data_["og_open2_on_loc_area"] = 0;
...
data_["amen_sec_area"] = 0;

data_["amen_loc_loc_area"] = 0;

data_["amen_loc_area"] = __modules__.attrib.Get(__params__.model, null, 'amen_loc_area');

data_["og_amen0_on_art_area"] = 0;

data_["og_amen0_on_sec_area"] = 0;

data_["og_amen0_on_loc_area"] = __modules__.attrib.Get(__params__.model, null, 'og_amen0_on_loc_area');

data_["og_amen1_on_loc_area"] = 0;

data_["og_amen2_on_loc_area"] = 0;
...
data_["lot_art_area"] = __modules__.attrib.Get(__params__.model, null, 'lot_art_area');
...
data_["lot_sec_area"] = __modules__.attrib.Get(__params__.model, null, 'lot_sec_area');

data_["lot_loc_loc_area"] = __modules__.attrib.Get(__params__.model, null, 'lot_loc_loc_area');

data_["lot_loc_area"] = __modules__.attrib.Get(__params__.model, null, 'lot_loc_area');
...
data_["lot_loc_loc_num"] = __modules__.attrib.Get(__params__.model, null, 'lot_loc_loc_num');

data_["lot_loc_num"] = __modules__.attrib.Get(__params__.model, null, 'lot_loc_num');

data_["road_area_art"] = __modules__.attrib.Get(__params__.model, null, 'road_area_art');

data_["road_area_sec"] = __modules__.attrib.Get(__params__.model, null, 'road_area_sec');
...
var merged;
let result_exec_neighbourhood_node_96um7idawy = __params__.model;

__params__.model = result_exec_neighbourhood_node_96um7idawy;

let result_exec_neighbourhood_node_mcjzxfeajj = await exec_neighbourhood_node_mcjzxfeajj(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_mcjzxfeajj);

let result_exec_neighbourhood_node_vns93romfj = await exec_neighbourhood_node_vns93romfj(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_vns93romfj);

let result_exec_neighbourhood_node_pjizno9ndm8 = await exec_neighbourhood_node_pjizno9ndm8(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_pjizno9ndm8;

let result_exec_neighbourhood_node_hm6u1njdu3f = await exec_neighbourhood_node_hm6u1njdu3f(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_vns93romfj);

let result_exec_neighbourhood_node_knp6k1v58dq = await exec_neighbourhood_node_knp6k1v58dq(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_vns93romfj;

let result_exec_neighbourhood_node_elz3xtiqwf8 = await exec_neighbourhood_node_elz3xtiqwf8(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_elz3xtiqwf8;

let result_exec_neighbourhood_node_4gdnewpxwwu = await exec_neighbourhood_node_4gdnewpxwwu(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_4gdnewpxwwu;

let result_exec_neighbourhood_node_2c4juo1tti6 = await exec_neighbourhood_node_2c4juo1tti6(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_2c4juo1tti6);

let result_exec_neighbourhood_node_w96d0ucdegl = await exec_neighbourhood_node_w96d0ucdegl(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_2c4juo1tti6;

let result_exec_neighbourhood_node_5p4odknefru = await exec_neighbourhood_node_5p4odknefru(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = mergeInputs([result_exec_neighbourhood_node_knp6k1v58dq, result_exec_neighbourhood_node_5p4odknefru]);

let result_exec_neighbourhood_node_eoe23c5qyyu = await exec_neighbourhood_node_eoe23c5qyyu(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_eoe23c5qyyu;

let result_exec_neighbourhood_node_1i0m7sn8thsi = await exec_neighbourhood_node_1i0m7sn8thsi(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_5p4odknefru);

let result_exec_neighbourhood_node_6g0o7kaz6sc = await exec_neighbourhood_node_6g0o7kaz6sc(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_6g0o7kaz6sc;

let result_exec_neighbourhood_node_hbqvmbucuob = await exec_neighbourhood_node_hbqvmbucuob(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_hbqvmbucuob;

let result_exec_neighbourhood_node_kw8bpjsjyf7 = await exec_neighbourhood_node_kw8bpjsjyf7(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_kw8bpjsjyf7);

let result_exec_neighbourhood_node_fkmuzw4ixv5 = await exec_neighbourhood_node_fkmuzw4ixv5(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_kw8bpjsjyf7);

let result_exec_neighbourhood_node_o3rnayqjeg = await exec_neighbourhood_node_o3rnayqjeg(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_kw8bpjsjyf7;

let result_exec_neighbourhood_node_gdxt2hr7i5k = await exec_neighbourhood_node_gdxt2hr7i5k(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_5p4odknefru;

let result_exec_neighbourhood_node_mx5n1w8ixqf = await exec_neighbourhood_node_mx5n1w8ixqf(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_mx5n1w8ixqf;

let result_exec_neighbourhood_node_fq5z4j8z3n = await exec_neighbourhood_node_fq5z4j8z3n(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_fq5z4j8z3n;

let result_exec_neighbourhood_node_0ib4xajdpzy = await exec_neighbourhood_node_0ib4xajdpzy(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_0ib4xajdpzy);

let result_exec_neighbourhood_node_8f0wt4mmgwj = await exec_neighbourhood_node_8f0wt4mmgwj(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_8f0wt4mmgwj;

let result_exec_neighbourhood_node_m0ivs8ifyp = await exec_neighbourhood_node_m0ivs8ifyp(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_m0ivs8ifyp;

let result_exec_neighbourhood_node_3kazw9j16ty = await exec_neighbourhood_node_3kazw9j16ty(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_3kazw9j16ty;

let result_exec_neighbourhood_node_a30k6jwp7xi = await exec_neighbourhood_node_a30k6jwp7xi(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_a30k6jwp7xi;

let result_exec_neighbourhood_node_n6sk1b2l88a = await exec_neighbourhood_node_n6sk1b2l88a(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_n6sk1b2l88a;

let result_exec_neighbourhood_node_fvux7ub6ibw = await exec_neighbourhood_node_fvux7ub6ibw(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_fvux7ub6ibw;

let result_exec_neighbourhood_node_bgur6o37386 = await exec_neighbourhood_node_bgur6o37386(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_0ib4xajdpzy;

let result_exec_neighbourhood_node_pd0yb9y8m6l = await exec_neighbourhood_node_pd0yb9y8m6l(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_pd0yb9y8m6l;

let result_exec_neighbourhood_node_6s7bq59zp8a = await exec_neighbourhood_node_6s7bq59zp8a(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_6s7bq59zp8a;

let result_exec_neighbourhood_node_yut8a8x67s = await exec_neighbourhood_node_yut8a8x67s(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = mergeInputs([result_exec_neighbourhood_node_bgur6o37386, result_exec_neighbourhood_node_yut8a8x67s]);

let result_exec_neighbourhood_node_fzi1kh9qotd = await exec_neighbourhood_node_fzi1kh9qotd(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = mergeInputs([result_exec_neighbourhood_node_gdxt2hr7i5k, result_exec_neighbourhood_node_fzi1kh9qotd]);

let result_exec_neighbourhood_node_rom187sf79 = await exec_neighbourhood_node_rom187sf79(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_rom187sf79);

let result_exec_neighbourhood_node_mww3dvuraq = await exec_neighbourhood_node_mww3dvuraq(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_rom187sf79;

let result_exec_neighbourhood_node_3oyy9it44r6 = await exec_neighbourhood_node_3oyy9it44r6(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_3oyy9it44r6;

let result_exec_neighbourhood_node_hufy15hg81 = await exec_neighbourhood_node_hufy15hg81(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = mergeInputs([result_exec_neighbourhood_node_fkmuzw4ixv5, result_exec_neighbourhood_node_o3rnayqjeg, result_exec_neighbourhood_node_hufy15hg81]);

let result_exec_neighbourhood_node_96mwqabz8q = await exec_neighbourhood_node_96mwqabz8q(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_96mwqabz8q;

let result_exec_neighbourhood_node_2phj4uf1mgw = await exec_neighbourhood_node_2phj4uf1mgw(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_2phj4uf1mgw;

let result_exec_neighbourhood_node_2emb9m2figr = await exec_neighbourhood_node_2emb9m2figr(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_2emb9m2figr;

let result_exec_neighbourhood_node_clktvp1e1wu = await exec_neighbourhood_node_clktvp1e1wu(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_clktvp1e1wu;

let result_exec_neighbourhood_node_wy7z9ed12ym = await exec_neighbourhood_node_wy7z9ed12ym(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = duplicateModel(result_exec_neighbourhood_node_wy7z9ed12ym);

let result_exec_neighbourhood_node_tbb61z2u4kf = await exec_neighbourhood_node_tbb61z2u4kf(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = result_exec_neighbourhood_node_mcjzxfeajj;

let result_exec_neighbourhood_node_8x119e8gvbx = await exec_neighbourhood_node_8x119e8gvbx(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = mergeInputs([result_exec_neighbourhood_node_hm6u1njdu3f, result_exec_neighbourhood_node_knp6k1v58dq, result_exec_neighbourhood_node_w96d0ucdegl, result_exec_neighbourhood_node_1i0m7sn8thsi, result_exec_neighbourhood_node_8x119e8gvbx]);

let result_exec_neighbourhood_node_z7ljwgpymsd = await exec_neighbourhood_node_z7ljwgpymsd(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

__params__.model = mergeInputs([result_exec_neighbourhood_node_wy7z9ed12ym, result_exec_neighbourhood_node_z7ljwgpymsd]);

let result_exec_neighbourhood_node_ocysq9x64x8 = await exec_neighbourhood_node_ocysq9x64x8(__params__, road_art_w_, road_sec_w_, road_loc_w_, part_art_d_, part_sec_d_, part_loc_d_, part_og_d_, part_og_w_, plot_art_w_, plot_sec_w_, plot_loc_w_, blk_art_num_og_d_, blk_art_num_og_w_, blk_sec_num_og_d_, blk_sec_num_og_w_, blk_loc_num_og_d_, blk_loc_num_og_w_, path_w_, open_percent_, amen_percent_);

return result_exec_neighbourhood_node_ocysq9x64x8;
}
...
function printInp(road_art_w,road_sec_w,road_loc_w,part_art_d,part_sec_d,part_loc_d,part_og_d,part_og_w,plot_art_w,plot_sec_w,plot_loc_w,blk_art_num_og_d,blk_art_num_og_w,blk_sec_num_og_d,blk_sec_num_og_w,blk_loc_num_og_d,blk_loc_num_og_w,path_w,open_percent,amen_percent){
...
printInp(road_art_w,road_sec_w,road_loc_w,part_art_d,part_sec_d,part_loc_d,part_og_d,part_og_w,plot_art_w,plot_sec_w,plot_loc_w,blk_art_num_og_d,blk_art_num_og_w,blk_sec_num_og_d,blk_sec_num_og_w,blk_loc_num_og_d,blk_loc_num_og_w,path_w,open_percent,amen_percent);
const __params__ = {};
...
const result = await exec_neighbourhood(__params__, road_art_w, road_sec_w, road_loc_w, part_art_d, part_sec_d, part_loc_d, part_og_d, part_og_w, plot_art_w, plot_sec_w, plot_loc_w, blk_art_num_og_d, blk_art_num_og_w, blk_sec_num_og_d, blk_sec_num_og_w, blk_loc_num_og_d, blk_loc_num_og_w, path_w, open_percent, amen_percent);
